...
namespace ThoughtWorks.CruiseControl.Core.Tasks
{
        ...
        : TaskBase
 {
  ...
  private ProcessResult TryToRun(IIntegrationResult result)
  {
   ...
   {
    string message = string.Format("Unable to launch the devenv process.  Please verify that you can invoke this command from_ the command line: {0} {1}", processInfo.FileName, processInfo.SafeArguments);
