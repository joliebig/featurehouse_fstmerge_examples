...
namespace ThoughtWorks.CruiseControl.Core.Sourcecontrol
{
 ...
 {
  Modification[] GetModifications(ISourceControl sourceControl, IIntegrationResult from_, IIntegrationResult to);
 }
 public class QuietPeriod : IQuietPeriod
 {
  ...
  private Modification[] GetModificationsWithLogging(ISourceControl sc, IIntegrationResult from_, IIntegrationResult to)
  {
   Modification[] modifications = sc.GetModifications(from_, to);
