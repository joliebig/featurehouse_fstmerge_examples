...
<project name=""foo"" />";
   ...
   Assert.AreEqual(0, project.ModificationDelaySeconds);
...
<project name=""foo"">
 <triggers/>
  ...
  public void RunningFirstIntegrationShouldForceBuild()
  {
   ...
   mockLabeller.ExpectAndReturn("Generate", "label", new IsAnything());
   mockSourceControl.ExpectAndReturn("GetModifications", new Modification[0], new IsAnything(), new IsAnything());
