...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
 ...
 {
  private static DateTime from_ = DateTime.Now.AddMinutes(-10);
  ...
  {
   mksHistoryParserWrapper.ExpectAndReturn("Parse", new Modification[0], new IsTypeOf(typeof (TextReader)), from_, TO);
   ...
   Modification[] modifications = mks.GetModifications(IntegrationResultMother.CreateSuccessful(from_), IntegrationResultMother.CreateSuccessful(TO));
  ...
  public void GetModificationsCallsParseMemberInfo()
  {
   ...
   mksHistoryParserWrapper.ExpectAndReturn("Parse", new Modification[] {addedModification}, new IsTypeOf(typeof (TextReader)), from_, TO);
  ...
  public void GetModificationsCallsMemberInfoForNonDeletedModifications()
  {
   ...
   mksHistoryParserWrapper.ExpectAndReturn("Parse", new Modification[] {addedModification, modifiedModification, deletedModification}, new IsTypeOf(typeof (TextReader)), from_, TO);
  ...
  {
   Modification modificationBeforePreviousIntegration = ModificationMother.CreateModification("ccnet", from_.AddMinutes(-2));
   ...
   mksHistoryParserWrapper.ExpectAndReturn("Parse", integrationModifications, new IsTypeOf(typeof (TextReader)), from_, TO);
