...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
 ...
 public class PlasticSCMHistoryParserTest : CustomAssertion
 {
  ...
  private readonly DateTime from_ = DateTime.ParseExact ("24/05/2007 17:04:10", PlasticSCM.DATEFORMAT, System.Globalization.CultureInfo.InvariantCulture);
  ...
  {
   Modification[] mods = parser.Parse (new StringReader(queryresult), from_, to);
