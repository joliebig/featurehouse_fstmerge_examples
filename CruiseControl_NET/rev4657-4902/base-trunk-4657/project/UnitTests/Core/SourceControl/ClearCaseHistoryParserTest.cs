...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
 ...
 public class ClearCaseHistoryParserTest
 {
  ...
  {
   string[] tokens = parser.TokenizeEntry( @"ppunjani#~#Friday, March 21, 2003 03:32:24 PM#~#D:\CCase\ppunjani_view\RefArch\tutorial\wwhdata\common\files.js#~##~#mkelem#~#!#~#!#~#made from_ flat file" );
   Assert.AreEqual( 8, tokens.Length );
   Assert.AreEqual( "ppunjani", tokens[0] );
   ...
   Assert.AreEqual( "!", tokens[5] );
   Assert.AreEqual( "!", tokens[6] );
   Assert.AreEqual( "made from_ flat file", tokens[7] );
  }
  [Test]
