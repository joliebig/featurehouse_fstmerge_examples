...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
 ...
 public class SvnTest : ProcessExecutorTestFixtureBase
 {
  ...
  {
   from_ = DateTime.Parse("2001-01-21 20:00:00Z");
  ...
  public void ShouldGetModificationsEvenWhenTrunkUrlIsNull()
  {
   ...
   Modification[] modifications = svn.GetModifications(IntegrationResult(from_), IntegrationResult(to));
...
<svn>
 ...
 <checkExternals>true</checkExternals>
  ...
  public void CreatingHistoryProcessIncludesCorrectlyFormattedArguments()
  {
   ...
   svn.GetModifications(IntegrationResult(from_), IntegrationResult(to));
  }
  [Test]
  ...
  public void ShouldRebaseWorkingDirectoryForHistory()
  {
   ...
   svn.GetModifications(IntegrationResult(from_), result);
  }
  [Test]
  public void ShouldApplyLabelIfTagOnSuccessTrue()
  {
   ExpectToExecuteArguments(@"copy -m ""CCNET build foo"" c:\source svn:");
  ...
  public void ShouldApplyLabelUsingRebasedWorkingDirectory()
  {
   ...
   IIntegrationResult result = IntegrationResult(from_);
   result.Label = "foo";
