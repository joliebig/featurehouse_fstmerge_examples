...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol.Telelogic
{
 ...
 public sealed class SynergyCommandBuilderTest : IntegrationFixture
 {
  ...
  public void TestFixtureSetUp()
  {
   ...
   connection.ClientDatabaseDirectory = @"C:\cmsynergy\u0000";
  ...
  public void SetUp()
  {
            result = Integration("MyCCNETProject", String.Empty, String.Empty);
  ...
  public void Start()
  {
   ...
   ValidateProcessInfo(actual, @"start -nogui -q -m -h ""localhost"" -d ""\\server\share\dbname"" -p ""MyProject-MyProject_Int"" -n ""jdoe"" -pw ""password"" -r ""build_mgr"" -u ""C:\cmsynergy\u0000"" -home ""C:\cmsynergy\jdoe""");
  }
  [Test]
  public void Stop()
  {
