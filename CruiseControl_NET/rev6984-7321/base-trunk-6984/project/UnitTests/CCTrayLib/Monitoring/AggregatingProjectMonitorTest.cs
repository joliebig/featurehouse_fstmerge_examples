...
namespace ThoughtWorks.CruiseControl.UnitTests.CCTrayLib.Monitoring
{
 ...
 public class AggregatingProjectMonitorTest
 {
  ...
  {
   monitor1.ExpectAndReturn("SummaryStatusString", "hello from_ monitor1");
   monitor2.ExpectAndReturn("SummaryStatusString", "and from_ monitor2");
   monitor3.ExpectAndReturn("SummaryStatusString", "goodbye from_ monitor3");
   string statusString = aggregator.SummaryStatusString;
   Assert.AreEqual("hello from_ monitor1\nand from_ monitor2\ngoodbye from_ monitor3", statusString);
  }
  [Test]
