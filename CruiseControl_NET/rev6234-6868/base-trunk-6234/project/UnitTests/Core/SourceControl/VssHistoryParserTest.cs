...
Comment: added fir to tree file, checked in recursively from_ project root";
   ...
   Assert.AreEqual("added fir to tree file, checked in recursively from_ project root",mod.Comment);
  }
  [Test]
