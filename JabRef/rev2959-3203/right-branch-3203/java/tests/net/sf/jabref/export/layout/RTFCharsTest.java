...
public class RTFCharsTest extends TestCase {
	...
	public void testBasicFormat() {
		...
		assertEquals("R\\ulexions sur le timing de la quantit\\u", layout.format("R�flexions sur le timing de la quantit�"));
	...
	public void testComplicated() {
		...
		assertEquals("R\\ulexions sur le timing de la quantit\\u \\u should be \\u", layout.format("R�flexions sur le timing de la quantit� \\ae should be �"));
	...
	public void testSpecialCharacters() {
		...
		assertEquals("", layout.format("\\L"));
		assertEquals("{\\u\\u}", layout.format("\\ss")); 
		assertEquals("", layout.format("?`")); 
		assertEquals("", layout.format("!`")); 
