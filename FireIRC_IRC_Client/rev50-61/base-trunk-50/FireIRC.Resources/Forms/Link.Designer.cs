namespace OVT.FireIRC.Resources
{
    partial class Link
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "{FireIRC.Link.Notice1}";
            ...
            this.label2.Text = "{FireIRC.Link.Notice2}";
