...
using RssBandit.WinGui.Controls; namespace  RssBandit.WinGui {
  ...
  bool IUIElementDrawFilter.DrawElement( DrawPhase drawPhase, ref UIElementDrawParams drawParams )
  {
   ...
   if ( treeNode != null )
   {
    ...
    if(treeNode.Level==0)
    {
     ...
     drawParams.Graphics.DrawString((string)treeNode.Cells[0].Value , new Font(drawParams.Font,FontStyle.Bold),
