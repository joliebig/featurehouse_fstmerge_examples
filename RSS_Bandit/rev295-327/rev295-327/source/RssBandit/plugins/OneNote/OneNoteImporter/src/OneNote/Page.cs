...
using System.Text; 
using System.Xml; 
using System.Xml.Schema; namespace  Microsoft.Office.OneNote {
 ...
 public class  Page  : ImportNode, IEnumerable {
  ...
  private  const string XmlNamespace = "http://schemas.microsoft.com/office/onenote/2004/import"; class  PageEnumerator  : IEnumerator {
