...
public class SQLTokenContext extends TokenContext
{
   ...
   public static final BaseTokenID WHITESPACE
      = new BaseTokenID("whitespace", WHITESPACE_ID); 

   public static final BaseTokenID IDENTIFIER
      = new BaseTokenID("identifier", IDENTIFIER_ID); 

   public static final BaseTokenID TABLE
      = new BaseTokenID("table", TABLE_ID); 

   public static final BaseTokenID SEQUENCE
   = new BaseTokenID("sequence", SEQUENCE_ID); 
   
   public static final BaseTokenID COLUMN
      = new BaseTokenID("column", COLUMN_ID); 

   public static final BaseTokenID ERROR
      = new BaseTokenID("error", ERROR_ID); 

	public static final BaseTokenID FUNCTION
		= new BaseTokenID("function", FUNCTION_ID); 

	public static final BaseTokenID DATA_TYPE
		= new BaseTokenID("dataType", DATA_TYPE_ID); 

	public static final BaseTokenID STATEMENT_SEPARATOR
		= new BaseTokenID("statementSeparator", STATEMENT_SEPARATOR_ID); 
   ...
   public static final BaseTokenID BLOCK_COMMENT
      = new BaseTokenID("block-comment", BLOCK_COMMENT_ID); 
   ...
   public static final BaseTokenID STRING_LITERAL
      = new BaseTokenID("string-literal", STRING_LITERAL_ID); 

   
   public static final BaseTokenID INT_LITERAL
      = new BaseTokenID("int-literal", INT_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseTokenID LONG_LITERAL
      = new BaseTokenID("long-literal", LONG_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseTokenID HEX_LITERAL
      = new BaseTokenID("hex-literal", HEX_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseTokenID OCTAL_LITERAL
      = new BaseTokenID("octal-literal", OCTAL_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseTokenID FLOAT_LITERAL
      = new BaseTokenID("float-literal", FLOAT_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseTokenID DOUBLE_LITERAL
      = new BaseTokenID("double-literal", DOUBLE_LITERAL_ID, NUMERIC_LITERALS); 

   
   public static final BaseImageTokenID EQ
      = new BaseImageTokenID("eq", EQ_ID, OPERATORS, "="); 

   public static final BaseImageTokenID LT
      = new BaseImageTokenID("lt", LT_ID, OPERATORS, "<"); 

   public static final BaseImageTokenID GT
      = new BaseImageTokenID("gt", GT_ID, OPERATORS, ">"); 

   public static final BaseImageTokenID LSHIFT
      = new BaseImageTokenID("lshift", LSHIFT_ID, OPERATORS, "<<"); 

   public static final BaseImageTokenID RSSHIFT
      = new BaseImageTokenID("rsshift", RSSHIFT_ID, OPERATORS, ">>"); 

   public static final BaseImageTokenID RUSHIFT
      = new BaseImageTokenID("rushift", RUSHIFT_ID, OPERATORS, ">>>"); 

   public static final BaseImageTokenID PLUS
      = new BaseImageTokenID("plus", PLUS_ID, OPERATORS, "+"); 

   public static final BaseImageTokenID MINUS
      = new BaseImageTokenID("minus", MINUS_ID, OPERATORS, "-"); 

   public static final BaseImageTokenID MUL
      = new BaseImageTokenID("mul", MUL_ID, OPERATORS, "*"); 

   public static final BaseImageTokenID DIV
      = new BaseImageTokenID("div", DIV_ID, OPERATORS, "/"); 

   public static final BaseImageTokenID AND
      = new BaseImageTokenID("and", AND_ID, OPERATORS, "&"); 

   public static final BaseImageTokenID OR
      = new BaseImageTokenID("or", OR_ID, OPERATORS, "|"); 

   public static final BaseImageTokenID XOR
      = new BaseImageTokenID("xor", XOR_ID, OPERATORS, "^"); 

   public static final BaseImageTokenID MOD
      = new BaseImageTokenID("mod", MOD_ID, OPERATORS, "%"); 

   public static final BaseImageTokenID NOT
      = new BaseImageTokenID("not", NOT_ID, OPERATORS, "!"); 

   public static final BaseImageTokenID NEG
      = new BaseImageTokenID("neg", NEG_ID, OPERATORS, "~"); 


   public static final BaseImageTokenID EQ_EQ
      = new BaseImageTokenID("eq-eq", EQ_EQ_ID, OPERATORS, "=="); 

   public static final BaseImageTokenID LT_EQ
      = new BaseImageTokenID("le", LT_EQ_ID, OPERATORS, "<="); 

   public static final BaseImageTokenID GT_EQ
      = new BaseImageTokenID("ge", GT_EQ_ID, OPERATORS, ">="); 

   public static final BaseImageTokenID LSHIFT_EQ
      = new BaseImageTokenID("lshift-eq", LSHIFT_EQ_ID, OPERATORS, "<<="); 

   public static final BaseImageTokenID RSSHIFT_EQ
      = new BaseImageTokenID("rsshift-eq", RSSHIFT_EQ_ID, OPERATORS, ">>="); 

   public static final BaseImageTokenID RUSHIFT_EQ
      = new BaseImageTokenID("rushift-eq", RUSHIFT_EQ_ID, OPERATORS, ">>>="); 

   public static final BaseImageTokenID PLUS_EQ
      = new BaseImageTokenID("plus-eq", PLUS_EQ_ID, OPERATORS, "+="); 

   public static final BaseImageTokenID MINUS_EQ
      = new BaseImageTokenID("minus-eq", MINUS_EQ_ID, OPERATORS, "-="); 

   public static final BaseImageTokenID MUL_EQ
      = new BaseImageTokenID("mul-eq", MUL_EQ_ID, OPERATORS, "*="); 

   public static final BaseImageTokenID DIV_EQ
      = new BaseImageTokenID("div-eq", DIV_EQ_ID, OPERATORS, "/="); 

   public static final BaseImageTokenID AND_EQ
      = new BaseImageTokenID("and-eq", AND_EQ_ID, OPERATORS, "&="); 

   public static final BaseImageTokenID OR_EQ
      = new BaseImageTokenID("or-eq", OR_EQ_ID, OPERATORS, "|="); 

   public static final BaseImageTokenID XOR_EQ
      = new BaseImageTokenID("xor-eq", XOR_EQ_ID, OPERATORS, "^="); 

   public static final BaseImageTokenID MOD_EQ
      = new BaseImageTokenID("mod-eq", MOD_EQ_ID, OPERATORS, "%="); 

   public static final BaseImageTokenID NOT_EQ
      = new BaseImageTokenID("not-eq", NOT_EQ_ID, OPERATORS, "!="); 


   public static final BaseImageTokenID DOT
      = new BaseImageTokenID("dot", DOT_ID, OPERATORS, "."); 

   public static final BaseImageTokenID COMMA
      = new BaseImageTokenID("comma", COMMA_ID, OPERATORS, ","); 

   public static final BaseImageTokenID COLON
      = new BaseImageTokenID("colon", COLON_ID, OPERATORS, ":"); 

   public static final BaseImageTokenID SEMICOLON
      = new BaseImageTokenID("semicolon", SEMICOLON_ID, OPERATORS, ";"); 

   public static final BaseImageTokenID QUESTION
      = new BaseImageTokenID("question", QUESTION_ID, OPERATORS, "?"); 

   public static final BaseImageTokenID LPAREN
      = new BaseImageTokenID("lparen", LPAREN_ID, OPERATORS, "("); 

   public static final BaseImageTokenID RPAREN
      = new BaseImageTokenID("rparen", RPAREN_ID, OPERATORS, ")"); 

   public static final BaseImageTokenID LBRACKET
      = new BaseImageTokenID("lbracket", LBRACKET_ID, OPERATORS, "["); 

   public static final BaseImageTokenID RBRACKET
      = new BaseImageTokenID("rbracket", RBRACKET_ID, OPERATORS, "]"); 

   public static final BaseImageTokenID LBRACE
      = new BaseImageTokenID("lbrace", LBRACE_ID, OPERATORS, "{"); 

   public static final BaseImageTokenID RBRACE
      = new BaseImageTokenID("rbrace", RBRACE_ID, OPERATORS, "}"); 

   public static final BaseImageTokenID PLUS_PLUS
      = new BaseImageTokenID("plus-plus", PLUS_PLUS_ID, OPERATORS, "++"); 

   public static final BaseImageTokenID MINUS_MINUS
      = new BaseImageTokenID("minus-minus", MINUS_MINUS_ID, OPERATORS, "--"); 

   public static final BaseImageTokenID AND_AND
      = new BaseImageTokenID("and-and", AND_AND_ID, OPERATORS, "&&"); 

   public static final BaseImageTokenID OR_OR
      = new BaseImageTokenID("or-or", OR_OR_ID, OPERATORS, "||"); 
   ...
   public static final BaseImageTokenID BYTE
      = new BaseImageTokenID("byte", BYTE_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID INT
      = new BaseImageTokenID("int", INT_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID ASSERT
      = new BaseImageTokenID("assert", ASSERT_ID, KEYWORDS); 

   public static final BaseImageTokenID BREAK
      = new BaseImageTokenID("break", BREAK_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID CATCH
      = new BaseImageTokenID("catch", CATCH_ID, KEYWORDS); 

   public static final BaseImageTokenID CLASS
      = new BaseImageTokenID("class", CLASS_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID CONTINUE
      = new BaseImageTokenID("continue", CONTINUE_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID DO
      = new BaseImageTokenID("do", DO_ID, KEYWORDS); 

   public static final BaseImageTokenID ELSE
      = new BaseImageTokenID("else", ELSE_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID EXTENDS
      = new BaseImageTokenID("extends", EXTENDS_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID FINAL
      = new BaseImageTokenID("final", FINAL_ID, KEYWORDS); 

   public static final BaseImageTokenID FINALLY
      = new BaseImageTokenID("finally", FINALLY_ID, KEYWORDS); 

   public static final BaseImageTokenID FOR
      = new BaseImageTokenID("for", FOR_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID IF
      = new BaseImageTokenID("if", IF_ID, KEYWORDS); 

   public static final BaseImageTokenID IMPLEMENTS
      = new BaseImageTokenID("implements", IMPLEMENTS_ID, KEYWORDS); 

   public static final BaseImageTokenID IMPORT
      = new BaseImageTokenID("import", IMPORT_ID, KEYWORDS); 

   public static final BaseImageTokenID INSTANCEOF
      = new BaseImageTokenID("instanceof", INSTANCEOF_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID NEW
      = new BaseImageTokenID("new", NEW_ID, KEYWORDS); 

   public static final BaseImageTokenID NULL
      = new BaseImageTokenID("null", NULL_ID, KEYWORDS); 

   public static final BaseImageTokenID PACKAGE
      = new BaseImageTokenID("package", PACKAGE_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID PROTECTED
      = new BaseImageTokenID("protected", PROTECTED_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID RETURN
      = new BaseImageTokenID("return", RETURN_ID, KEYWORDS); 

   public static final BaseImageTokenID STATIC
      = new BaseImageTokenID("static", STATIC_ID, KEYWORDS); 

   public static final BaseImageTokenID STRICTFP
      = new BaseImageTokenID("strictfp", STRICTFP_ID, KEYWORDS); 

   public static final BaseImageTokenID SUPER
      = new BaseImageTokenID("super", SUPER_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID SYNCHRONIZED
      = new BaseImageTokenID("synchronized", SYNCHRONIZED_ID, KEYWORDS); 

   public static final BaseImageTokenID THIS
      = new BaseImageTokenID("this", THIS_ID, KEYWORDS); 

   public static final BaseImageTokenID THROW
      = new BaseImageTokenID("throw", THROW_ID, KEYWORDS); 

   public static final BaseImageTokenID THROWS
      = new BaseImageTokenID("throws", THROWS_ID, KEYWORDS); 

   public static final BaseImageTokenID TRANSIENT
      = new BaseImageTokenID("transient", TRANSIENT_ID, KEYWORDS); 
   ...
   public static final BaseImageTokenID TRY
      = new BaseImageTokenID("try", TRY_ID, KEYWORDS); 

   public static final BaseImageTokenID VOLATILE
      = new BaseImageTokenID("volatile", VOLATILE_ID, KEYWORDS); 

   public static final BaseImageTokenID WHILE
      = new BaseImageTokenID("while", WHILE_ID, KEYWORDS); 

   
   public static final BaseTokenID INCOMPLETE_STRING_LITERAL
      = new BaseTokenID("incomplete-string-literal", INCOMPLETE_STRING_LITERAL_ID, ERRORS); 

   public static final BaseTokenID INCOMPLETE_CHAR_LITERAL
      = new BaseTokenID("incomplete-char-literal", INCOMPLETE_CHAR_LITERAL_ID, ERRORS); 

   public static final BaseTokenID INCOMPLETE_HEX_LITERAL
      = new BaseTokenID("incomplete-hex-literal", INCOMPLETE_HEX_LITERAL_ID, ERRORS); 

   public static final BaseTokenID INVALID_CHAR
      = new BaseTokenID("invalid-char", INVALID_CHAR_ID, ERRORS); 

   public static final BaseTokenID INVALID_OPERATOR
      = new BaseTokenID("invalid-operator", INVALID_OPERATOR_ID, ERRORS); 

   public static final BaseTokenID INVALID_OCTAL_LITERAL
      = new BaseTokenID("invalid-octal-literal", INVALID_OCTAL_LITERAL_ID, ERRORS); 

   public static final BaseTokenID INVALID_COMMENT_END
      = new BaseTokenID("invalid-comment-end", INVALID_COMMENT_END_ID, ERRORS); 


   
   
   public static final BaseTokenID ANNOTATION
      = new BaseTokenID("annotation", ANNOTATION_ID); 

   
   public static final BaseImageTokenID ELLIPSIS
      = new BaseImageTokenID("ellipsis", ELLIPSIS_ID, OPERATORS, "..."); 
