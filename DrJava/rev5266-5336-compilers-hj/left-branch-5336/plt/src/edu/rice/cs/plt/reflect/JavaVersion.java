...
public enum JavaVersion {
  ...
  public static FullVersion parseFullVersion(String java_version, String java_runtime_name, String java_vm_vendor) {
    ...
    if (java_runtime_name.toLowerCase().contains("hj")) {
        vendor = VendorType.HJ;
        vendorString = "HJ";
      }
  ...
  public static class FullVersion implements Comparable<FullVersion>, Serializable {
    ...
    public int compareTo(FullVersion v) {
      ...
      if ((_vendor==VendorType.HJ) && (v._vendor!=VendorType.HJ)) {
          
          return -1;
        }
        if ((v._vendor==VendorType.HJ) && (_vendor!=VendorType.HJ)) {
  ...
  public static enum VendorType {UNKNOWN, MINT, OPENJDK, APPLE, SUN, HJ; }
}
