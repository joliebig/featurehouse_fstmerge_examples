...
public class Viewer extends JmolViewer implements AtomDataServer {
  ...
  public Quaternion getAtomQuaternion(int i) {
    return (i < 0 ? null : modelSet.getQuaternion(i, getQuaternionFrame()));
  }
  ...
  public int calculateStruts(BitSet bs1, BitSet bs2) {
    return modelSet.calculateStruts(bs1 == null ? selectionManager.bsSelection
        : bs1, bs2 == null ? selectionManager.bsSelection : bs2);
  }
