  ...
  private boolean checkFlowCommand(String ident) {
    ...
    case Token.end:
      ...
      if (flowContext.token.tok != Token.function)
        setCommand(new Token(tokCommand, -flowContext.getPt0(), ident)); 
      break;
    case Token.ifcmd:
    case Token.forcmd:
    case Token.whilecmd:
    ...
    case Token.continuecmd:
      ...
      if (f == null)
        return error(ERROR_badContext, ident);
      setCommand( new Token(tokCommand, f.getPt0(), ident)); 
      break;
    case Token.elseif:
      if (flowContext == null || flowContext.token.tok != Token.ifcmd
          && flowContext.token.tok != Token.elseif
    ...
    if (isEnd) {
      ...
      setCommand(new Token(tokCommand, tokenCommand.value)); 
