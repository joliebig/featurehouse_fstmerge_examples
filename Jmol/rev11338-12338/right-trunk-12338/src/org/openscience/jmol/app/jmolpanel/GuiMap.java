...
class GuiMap {
  ...
  private Hashtable setupLabels() {
    ...
    labels.put("console", GT._("Output Conso&le..."));
    ...
    labels.put("bond100Script", GT._("{0} \u", "0.10"));
    labels.put("bond150Script", GT._("{0} \u", "0.15"));
    labels.put("bond200Script", GT._("{0} \u", "0.20"));
    ...
    labels.put("vector005Script", GT._("{0} \u", "0.05"));
    labels.put("vector01Script", GT._("{0} \u", "0.1"));
