...
public class StateManager {
  ...
  void clear() {
    ...
    viewer.setBooleanProperty("drawHover", false);
  }
  ...
  public Hashtable getFunctions(boolean isStatic) {
  ...
  boolean isFunction(String name) {
    return (isGlobalFunction(name) ? staticFunctions : localFunctions).containsKey(name);
  }

  void addFunction(ScriptFunction function) {
    (isGlobalFunction(function.name) ? staticFunctions
  ...
  ScriptFunction getFunction(String name) {
    if (name == null)
      return null;
    ScriptFunction function = (ScriptFunction) (isGlobalFunction(name) ? staticFunctions
