...
public class Token {
  ...
  final static int cd           = command | 7 | implicitStringCommand | expression;
  ...
  final public static int monitor      = command | 35 | setparam | expression | defaultON;
  ...
  final static int hkl                 = misc | 120 | expression;
