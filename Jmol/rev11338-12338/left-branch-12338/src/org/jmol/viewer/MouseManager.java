...
public abstract class MouseManager implements KeyListener {
  ...
  final static int ALT = Event.ALT_MASK; 
  final static int RIGHT = Event.META_MASK; 
  final static int CTRL = Event.CTRL_MASK; 
