...
class ScriptMathProcessor {
  ...
  private boolean evaluateSymop(ScriptVariable[] args, boolean haveBitSet) throws ScriptException {
    ...
    String desc = ScriptVariable.sValue(args[2]);
    return addX(viewer.getSymmetryInfo(bs, xyz, iOp, pt, desc, Token.draw));
  }
  ...
  private boolean operate() throws ScriptException {
    ...
    if (op.tok == Token.opNot)
      return (isSyntaxCheck ? addX(true) : x2.tok == Token.point4f ? 
