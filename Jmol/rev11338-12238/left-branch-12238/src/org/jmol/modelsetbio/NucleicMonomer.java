...
public class NucleicMonomer extends PhosphorusMonomer {
  ...
  final static byte[] interestingNucleicAtomIDs = {
    ...
    ~JmolConstants.ATOMID_O4,  
    ~JmolConstants.ATOMID_O6,  
    ~JmolConstants.ATOMID_N4,  
    ~JmolConstants.ATOMID_NUCLEIC_PHOSPHORUS, 
    ~JmolConstants.ATOMID_N6,  
    ~JmolConstants.ATOMID_N2,  

    ~JmolConstants.ATOMID_H5T_TERMINUS, 
    ~JmolConstants.ATOMID_O5_PRIME,     

    ~JmolConstants.ATOMID_H3T_TERMINUS, 
    JmolConstants.ATOMID_O3_PRIME,      
    JmolConstants.ATOMID_C3_PRIME,      
    
    ~JmolConstants.ATOMID_O1P,  
    ~JmolConstants.ATOMID_O2P,  
