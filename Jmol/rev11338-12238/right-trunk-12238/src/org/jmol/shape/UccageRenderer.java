...
public class UccageRenderer extends CageRenderer {
  ...
  private void renderInfo(SymmetryInterface symmetry) {
    ...
    g3d.drawStringNoSlab("a="
        + nfformat(symmetry.getUnitCellInfo(JmolConstants.INFO_A)) + "\u",
        null, x, y, 0);
    y += lineheight;
    g3d.drawStringNoSlab("b="
        + nfformat(symmetry.getUnitCellInfo(JmolConstants.INFO_B)) + "\u",
        null, x, y, 0);
    y += lineheight;
    g3d.drawStringNoSlab("c="
        + nfformat(symmetry.getUnitCellInfo(JmolConstants.INFO_C)) + "\u",
        null, x, y, 0);
    if (nf != null)
