...
public class Token {
  ...
  final static int applet        = misc | 8;
  ...
  final static int binary        = misc | 21;
  final static int blockdata     = misc | 22;
  final static int bondset       = misc | 23;
  final static int bottom        = misc | 24;
  final static int cap           = misc | 25 | expression;
  final static int cavity        = misc | 26;
  final static int check         = misc | 27;
  final static int circle        = misc | 28;
  ...
  final static int filter         = misc | 65;
  ...
  final static int title          = misc | 185;
  final static int titleformat    = misc | 186;
  final static int to             = misc | 187 | expression;
