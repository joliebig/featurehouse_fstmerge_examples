...
class firmwareresponse(BaseProtogenClass):
    __fields=['command', 'date1', 'time1', 'date2', 'time2', 'firmwareversion', 'dunno']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
...
class speeddial(BaseProtogenClass):
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_entry
            ...
            self.__field_entry=UINT(**{'sizeinbytes': 2, 'default': 0xff})
    ...
    def __setfield_entry(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_entry=UINT(value,**{'sizeinbytes': 2, 'default': 0xff})
...
class pbfileentry(BaseProtogenClass):
    __fields=['serial1', 'data1', 'group', 'data2', 'wallpaper', 'data3']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def readfrombuffer(self,buf):
        ...
        self.__field_serial1=UINT(**{'sizeinbytes': 4})
        self.__field_serial1.readfrombuffer(buf)
        self.__field_data1=UNKNOWN(**{'sizeinbytes': 25})
        self.__field_data1.readfrombuffer(buf)
        self.__field_group=UINT(**{'sizeinbytes': 2})
        self.__field_group.readfrombuffer(buf)
        self.__field_data2=UNKNOWN(**{'sizeinbytes': 232})
        self.__field_data2.readfrombuffer(buf)
        self.__field_wallpaper=UINT(**{'sizeinbytes': 1})
        self.__field_wallpaper.readfrombuffer(buf)
        self.__field_data3=UNKNOWN(**{'sizeinbytes': 15})
    ...
    def __setfield_data1(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_data1=UNKNOWN(value,**{'sizeinbytes': 25})
    ...
    def __setfield_data2(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_data2=UNKNOWN(value,**{'sizeinbytes': 232})
    ...
    def __setfield_data3(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_data3=UNKNOWN(value,**{'sizeinbytes': 15})
...
class scheduleevent(BaseProtogenClass):
    __fields=['pos', 'pad1', 'start', 'end', 'repeat', 'daybitmap', 'pad2', 'alarmminutes', 'alarmhours', 'alarmtype', 'snoozedelay', 'ringtone', 'description', 'hasvoice', 'voiceid']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_pad1
            ...
            self.__field_pad1=UINT(**{'sizeinbytes': 4,  'default': 0 })
    ...
    def __setfield_pad1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_pad1=UINT(value,**{'sizeinbytes': 4,  'default': 0 })
    ...
    def __setfield_hasvoice(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_hasvoice=UINT(value,**{'sizeinbytes': 1})
...
class callentry(BaseProtogenClass):
    __fields=['datetime', 'pad1', 'duration', 'number', 'name', 'pad2']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def readfrombuffer(self,buf):
        'Reads this packet from the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        self.__field_datetime=GPSDATE(**{'sizeinbytes': 4})
    ...
    def __setfield_datetime(self, value):
        if isinstance(value,GPSDATE):
            ...
            self.__field_datetime=GPSDATE(value,**{'sizeinbytes': 4})
    ...
    def __setfield_pad2(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_pad2=UNKNOWN(value,**{'sizeinbytes': 60})
    def __delfield_pad2(self): del self.__field_pad2
    pad2=property(__getfield_pad2, __setfield_pad2, __delfield_pad2, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        ...
        yield ('name', self.__field_name, None)
        yield ('pad2', self.__field_pad2, None)
class callhistoryfile(BaseProtogenClass):
    __fields=['itemcount', 'pad1', 'items']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(callhistoryfile,self).__init__(**dict)
        if self.__class__ is callhistoryfile:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(callhistoryfile,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(callhistoryfile,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
    def writetobuffer(self,buf):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        ...
        try: self.__field_items
            ...
            self.__field_items=LIST(**{ 'elementclass': callentry })
        self.__field_items.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def readfrombuffer(self,buf):
        'Reads this packet from the supplied buffer'
    ...
    def __setfield_items(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_items=LIST(value,**{ 'elementclass': callentry })
    def __delfield_items(self): del self.__field_items
    items=property(__getfield_items, __setfield_items, __delfield_items, None)
    def iscontainer(self):
        return True
...
class sms_out(BaseProtogenClass):
    __fields=['index', 'locked', 'timesent', 'subject', 'num_msg_elements', 'messages', 'unknown1', 'priority', 'callback', 'recipients', 'pad']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
...
class sms_in(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf):
        ...
        self.__field_unknown7=UINT(**{'sizeinbytes': 2})
    ...
    def __setfield_unknown7(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown7=UINT(value,**{'sizeinbytes': 2})
