...
class  PhoneWidget (wx.Panel) :
	...
	def OnCellSelect(self, event):
        ...
        self.SetPreview(self._data[self.dt.rowkeys[row]])
...
ImportDataTable.htmltemplate[4]=ImportDataTable.htmltemplate[0]
...
ImportDataTable.htmltemplate[12]='<font color="#aa0000"><font size=-1>%(imported)s</font></font>'
...
class  ImportDialog (wx.Dialog) :
	"The dialog for mixing new (imported) data with existing data"
        ...
        self.grid.RegisterDataType("string", cr, None) 
