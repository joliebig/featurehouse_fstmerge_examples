...
_NotSafeObject=_NotSafeObject() EVT_CALLBACK=None
...
class  MainWindow (wx.Frame) :
	...
	def SetActivePanel(self, panel):
        ...
        self.sw.GetWindow2().Show(False)

        self.sw.ReplaceWindow(self.sw.GetWindow2(), panel)
	...
	def OnDataGetPhoneResults(self, exception, results):
        ...
        if results['sync'].has_key('phonebook'):
            ...
            self.tree.GetActivePhone().phonewidget.importdata(results['phonebook'], results.get('categories', []), merge)
        ...
        if results['sync'].has_key('wallpaper'):
            ...
            self.tree.GetActivePhone().wallpaperwidget.populatefs(results)

            self.tree.GetActivePhone().wallpaperwidget.populate(results)

        if not updwp and results.has_key('wallpaper-index'):

            self.tree.GetActivePhone().wallpaperwidget.updateindex(results['wallpaper-index'])
        ...
        if results['sync'].has_key('ringtone'):
            ...
            self.tree.GetActivePhone().ringerwidget.populatefs(results)

            self.tree.GetActivePhone().ringerwidget.populate(results)

        if not updrng and results.has_key('ringtone-index'):

            self.tree.GetActivePhone().ringerwidget.updateindex(results['ringtone-index'])            
        ...
        if results['sync'].has_key('calendar'):
            ...
            self.tree.GetActivePhone().calendarwidget.populatefs(results)

            self.tree.GetActivePhone().calendarwidget.populate(results)
        ...
        if results['sync'].has_key('memo'):
            ...
            self.tree.GetActivePhone().memowidget.populatefs(results)

            self.tree.GetActivePhone().memowidget.populate(results)
        ...
        if results['sync'].has_key('todo'):
            ...
            self.tree.GetActivePhone().todowidget.populatefs(results)

            self.tree.GetActivePhone().todowidget.populate(results)
        ...
        if results['sync'].has_key('sms'):
            ...
            if v=='MERGE':
                ...
                self.tree.GetActivePhone().smswidget.merge(results)

            else:

                self.tree.GetActivePhone().smswidget.populatefs(results)

                self.tree.GetActivePhone().smswidget.populate(results)
        ...
        if results['sync'].has_key('call_history'):
            ...
            if v=='MERGE':
                ...
                self.tree.GetActivePhone().callhistorywidget.merge(results)

            else:

                self.tree.GetActivePhone().callhistorywidget.populatefs(results)

                self.tree.GetActivePhone().callhistorywidget.populate(results)
        ...
        if results['sync'].has_key(playlist.playlist_key):
            ...
            self.tree.GetActivePhone().playlistwidget.populatefs(results)

            self.tree.GetActivePhone().playlistwidget.populate(results)
	...
	def OnDataSendPhone(self, _):
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            if merge:
                ...
                want=self.tree.GetActivePhone().wallpaperwidget.SELECTED

            else:

                want=self.tree.GetActivePhone().wallpaperwidget.ALL

            self.tree.GetActivePhone().wallpaperwidget.getdata(data, want)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            if merge:
                ...
                want=self.tree.GetActivePhone().ringerwidget.SELECTED

            else:

                want=self.tree.GetActivePhone().ringerwidget.ALL

            self.tree.GetActivePhone().ringerwidget.getdata(data, want)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            self.tree.GetActivePhone().calendarwidget.getdata(data)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            if v==dlg.OVERWRITE: 
                ...
                self.tree.GetActivePhone().phonewidget.getdata(data)

                todo.append( (self.wt.writephonebook, "Phonebook") )

            convertors.append(self.tree.GetActivePhone().phonewidget.converttophone)

            funcscb.append(self.tree.GetActivePhone().phonewidget.updateserials)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            self.tree.GetActivePhone().memowidget.getdata(data)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            self.tree.GetActivePhone().todowidget.getdata(data)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            self.tree.GetActivePhone().smswidget.getdata(data)
        ...
        if v!=dlg.NOTREQUESTED:
            ...
            self.tree.GetActivePhone().playlistwidget.getdata(data)
	...
	<<<<<<< /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307436997198/fstmerge_var1_1896409034793251964
def OnNotebookPageChanged(self, _=None):
        ...
        self.tb.Realize()
=======
>>>>>>> /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307436997198/fstmerge_var2_5538115118489957758
...
if guihelper.IsMSWindows():
    ...
    class DeviceChanged:
        ...
        def _decode_struct(self, lparam):
            ...
            buf = win32gui.PyMakeBuffer(dbch_size, lparam) 
...
class  FileSystemFileView (wx.ListCtrl, listmix.ColumnSorterMixin) :
	<<<<<<< /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307437001018/fstmerge_var1_8196604666188751484
...
=======
>>>>>>> /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307437001018/fstmerge_var2_3028807352364017315
...
class  FileSystemDirectoryView (wx.TreeCtrl) :
	<<<<<<< /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307437003021/fstmerge_var1_3800308567268894982
def __init__(self, mainwindow, parent, id, style):
        ...
        self.ResetView()
=======
>>>>>>> /work/joliebig/semistructured_merge/fse2011_artifact/binary/fstmerge_tmp1307437003021/fstmerge_var2_1361096865406303565
