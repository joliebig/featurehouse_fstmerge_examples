...
class  listdirectoriesresponse (BaseProtogenClass) :
	...
	def readfrombuffer(self,buf):
        ...
        if self.numentries>0:
            ...
            self.__field_items=LIST(**{'elementclass': _gen_p_brew_96, 'length': self.numentries})
	...
	def __setfield_items(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_items=LIST(value,**{'elementclass': _gen_p_brew_96, 'length': self.numentries})
...
class  _gen_p_brew_96 (BaseProtogenClass) :
	'Anonymous inner class'
        ...
        super(_gen_p_brew_96,self).__init__(**dict)

        if self.__class__ is _gen_p_brew_96:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_brew_96,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_brew_96,kwargs)
...
mkdirresponse=responseheader rmdirresponse=responseheader rmfileresponse=responseheader writefileresponse=responseheader writefileblockresponse=responseheader setfileattrresponse=responseheader new_mkdirresponse=new_responseheader new_rmdirresponse=new_responseheader new_rmfileresponse=new_responseheader
