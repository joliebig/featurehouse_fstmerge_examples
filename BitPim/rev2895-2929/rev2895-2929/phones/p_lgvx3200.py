...
class  pbentry (BaseProtogenClass) :
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_entrysize
            ...
            self.__field_entrysize=UINT(**{'sizeinbytes': 2, 'constant': 0x0202})
        ...
        try: self.__field_emails
            ...
            self.__field_emails=LIST(**{'elementclass': _gen_p_lgvx3200_79, 'length': NUMEMAILS})
        ...
        try: self.__field_numbertypes
            ...
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvx3200_87, 'length': NUMPHONENUMBERS})
        ...
        try: self.__field_numbers
            ...
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lgvx3200_89, 'length': NUMPHONENUMBERS})
	...
	def __setfield_entrysize(self, value):
        ...
        if isinstance(value,UINT):
            ...
            self.__field_entrysize=UINT(value,**{'sizeinbytes': 2, 'constant': 0x0202})
	...
	def __setfield_emails(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgvx3200_79, 'length': NUMEMAILS})
	...
	def __setfield_numbertypes(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgvx3200_87, 'length': NUMPHONENUMBERS})
	...
	def __setfield_numbers(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lgvx3200_89, 'length': NUMPHONENUMBERS})
...
class  _gen_p_lgvx3200_79 (BaseProtogenClass) :
	'Anonymous inner class'
        ...
        super(_gen_p_lgvx3200_79,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_79:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_79,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_79,kwargs)
...
class  _gen_p_lgvx3200_87 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['numbertype']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_87,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_87:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_87,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_87,kwargs)
...
class  _gen_p_lgvx3200_89 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['number']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_89,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_89:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_89,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_89,kwargs)
...
class  pbgroup (BaseProtogenClass) :
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_name=STRING(**{'sizeinbytes': 23})
	...
	def __setfield_name(self, value):
        ...
        if isinstance(value,STRING):
            ...
            self.__field_name=STRING(value,**{'sizeinbytes': 23})
...
class  scheduleevent (BaseProtogenClass) :
	__fields=['pos', 'unknown', 'start', 'end', 'repeat', 'daybitmap', 'alarmminutes', 'alarmhours', 'alarmtype', 'snoozedelay', 'ringtone', 'description']
	    def __init__(self, *args, **kwargs):
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_daybitmap=UINT(**{'sizeinbytes': 3})
	...
	def __setfield_daybitmap(self, value):
        ...
        if isinstance(value,UINT):
            ...
            self.__field_daybitmap=UINT(value,**{'sizeinbytes': 3})
	...
	def __delfield_alarmtype(self): del self.__field_alarmtype
	    ...
	    alarmtype=property(__getfield_alarmtype, __setfield_alarmtype, __delfield_alarmtype, None)
	...
	def __delfield_snoozedelay(self): del self.__field_snoozedelay
	    ...
	    snoozedelay=property(__getfield_snoozedelay, __setfield_snoozedelay, __delfield_snoozedelay, None)
	    def __getfield_ringtone(self):
	...
	def containerelements(self):
        ...
        yield ('alarmtype', self.__field_alarmtype, None)

        yield ('snoozedelay', self.__field_snoozedelay, None)
...
class  call (BaseProtogenClass) :
	__fields=['GPStime', 'unknown1', 'duration', 'number', 'name', 'numberlength', 'unknown']
	    def __init__(self, *args, **kwargs):
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_unknown=UNKNOWN(**{'sizeinbytes': 6})
	...
	def __setfield_unknown(self, value):
        ...
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown=UNKNOWN(value,**{'sizeinbytes': 6})
...
class  msg_record (BaseProtogenClass) :
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx3200_213, 'length': 219})
	...
	def __setfield_msg(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx3200_213, 'length': 219})
...
class  _gen_p_lgvx3200_213 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['byte']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_213,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_213:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_213,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_213,kwargs)
...
class  recipient_record (BaseProtogenClass) :
	__fields=['status', 'timesent', 'timereceived', 'unknown', 'number']
	    def __init__(self, *args, **kwargs):
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_unknown=UNKNOWN(**{'sizeinbytes': 12})
	...
	def __setfield_unknown(self, value):
        ...
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown=UNKNOWN(value,**{'sizeinbytes': 12})
...
class  sms_out (BaseProtogenClass) :
	__fields=['index', 'locked', 'timesent', 'subject', 'num_msg_elements', 'messages', 'unknown', 'priority', 'callback', 'recipients']
	    def __init__(self, *args, **kwargs):
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_messages
            ...
            self.__field_messages=LIST(**{'elementclass': msg_record, 'length': 1})
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_unknown=UNKNOWN(**{'sizeinbytes': 39})
	...
	def __setfield_messages(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_messages=LIST(value,**{'elementclass': msg_record, 'length': 1})
	...
	def __setfield_unknown(self, value):
        ...
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown=UNKNOWN(value,**{'sizeinbytes': 39})
...
class  SMSINBOXMSGFRAGMENT (BaseProtogenClass) :
	...
	def _update(self, args, kwargs):
        ...
        if len(args):
            ...
            dict2={'elementclass': _gen_p_lgvx3200_244, 'length': 181}
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx3200_244, 'length': 181})
	...
	def __setfield_msg(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx3200_244, 'length': 181})
...
class  _gen_p_lgvx3200_244 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['byte']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_244,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_244:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_244,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_244,kwargs)
...
class  sms_in (BaseProtogenClass) :
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgvx3200_257, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgvx3200_277, 'length': 1 })
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'length': 1, 'elementclass': SMSINBOXMSGFRAGMENT})
	...
	def readfrombuffer(self,buf):
        ...
        self.__field_callback=STRING(**{'sizeinbytes': 34})
        ...
        self.__field_unknown4=DATA(**{'sizeinbytes': 12})
        ...
        self.__field_unknown1=UNKNOWN(**{'sizeinbytes': 3})
        ...
        self.__field_unknown5=DATA(**{'sizeinbytes': 44})
	...
	def __setfield_callback(self, value):
        ...
        if isinstance(value,STRING):
            ...
            self.__field_callback=STRING(value,**{'sizeinbytes': 34})
	...
	def __setfield_sender(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgvx3200_257, 'length': 38})
	...
	def __setfield_unknown4(self, value):
        ...
        if isinstance(value,DATA):
            ...
            self.__field_unknown4=DATA(value,**{'sizeinbytes': 12})
	...
	def __setfield_unknown1(self, value):
        ...
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown1=UNKNOWN(value,**{'sizeinbytes': 3})
	...
	def __setfield_msglengths(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgvx3200_277, 'length': 1 })
	...
	def __setfield_msgs(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'length': 1, 'elementclass': SMSINBOXMSGFRAGMENT})
	...
	def __setfield_unknown5(self, value):
        ...
        if isinstance(value,DATA):
            ...
            self.__field_unknown5=DATA(value,**{'sizeinbytes': 44})
	...
	def __setfield_unknown6(self, value):
        ...
        if isinstance(value,DATA):
            ...
            self.__field_unknown6=DATA(value,)
...
class  _gen_p_lgvx3200_257 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['byte']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_257,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_257:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_257,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_257,kwargs)
...
class  _gen_p_lgvx3200_277 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['msglength']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_277,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_277:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_277,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_277,kwargs)
...
class  sms_quick_text (BaseProtogenClass) :
	...
	def _update(self, args, kwargs):
        ...
        if len(args):
            ...
            dict2={'elementclass': _gen_p_lgvx3200_293, }
	...
	def writetobuffer(self,buf):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgvx3200_293, })
	...
	def __setfield_msgs(self, value):
        ...
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgvx3200_293, })
...
class  _gen_p_lgvx3200_293 (BaseProtogenClass) :
	'Anonymous inner class'
	    __fields=['msg']
	    def __init__(self, *args, **kwargs):
        ...
        super(_gen_p_lgvx3200_293,self).__init__(**dict)

        if self.__class__ is _gen_p_lgvx3200_293:
	...
	def _update(self, args, kwargs):
        ...
        super(_gen_p_lgvx3200_293,self)._update(args,kwargs)
        ...
        if __debug__:
            ...
            self._complainaboutunusedargs(_gen_p_lgvx3200_293,kwargs)
