...
myEVT_DIRTY_UI=wx.NewEventType() EVT_DIRTY_UI=wx.PyEventBinder(myEVT_DIRTY_UI, 1)
...
class  RingtoneEditor (DirtyUIBase) :
	"Edit a ringtone"
        ...
        wx.CallAfter(pubsub.publish, pubsub.REQUEST_RINGTONES) 
...
class  WallpaperEditor (DirtyUIBase) :
	unnamed="Select:"
        ...
        wx.CallAfter(pubsub.publish, pubsub.REQUEST_WALLPAPERS) 
