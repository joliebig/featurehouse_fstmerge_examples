...
class indexentry(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf):
        ...
        self.__field_filename=STRING(**{'sizeinbytes': 60, 'raiseonunterminatedread': False, 'raiseontruncate': False })
    ...
    def __setfield_filename(self, value):
        if isinstance(value,STRING):
            ...
            self.__field_filename=STRING(value,**{'sizeinbytes': 60, 'raiseonunterminatedread': False, 'raiseontruncate': False })
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx5200_85, 'length': 219})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx5200_85, 'length': 219})
...
class _gen_p_lgvx5200_85(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvx5200_85,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx5200_85:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvx5200_85,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx5200_85,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx5200_124, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx5200_124, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def readfrombuffer(self,buf):
        'Reads this packet from the supplied buffer'
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx5200_124, 'length': 181})
    def __delfield_msg(self): del self.__field_msg
    msg=property(__getfield_msg, __setfield_msg, __delfield_msg, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('msg', self.__field_msg, None)
class _gen_p_lgvx5200_124(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvx5200_124,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx5200_124:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvx5200_124,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx5200_124,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgvx5200_134, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgvx5200_152, 'length': 10})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgvx5200_134, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgvx5200_152, 'length': 10})
...
class _gen_p_lgvx5200_134(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvx5200_134,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx5200_134:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvx5200_134,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx5200_134,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvx5200_152(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvx5200_152,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx5200_152:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvx5200_152,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx5200_152,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx5200_165, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgvx5200_165, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def readfrombuffer(self,buf):
        'Reads this packet from the supplied buffer'
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgvx5200_165, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
    def __delfield_msgs(self): del self.__field_msgs
    msgs=property(__getfield_msgs, __setfield_msgs, __delfield_msgs, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('msgs', self.__field_msgs, None)
class _gen_p_lgvx5200_165(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvx5200_165,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx5200_165:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvx5200_165,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx5200_165,kwargs)
        if len(args):
...
class textmemo(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf):
        ...
        self.__field_text=STRING(**{'sizeinbytes': 152,  'raiseonunterminatedread': False, 'raiseontruncate': False })
    ...
    def __setfield_text(self, value):
        if isinstance(value,STRING):
            ...
            self.__field_text=STRING(value,**{'sizeinbytes': 152,  'raiseonunterminatedread': False, 'raiseontruncate': False })
