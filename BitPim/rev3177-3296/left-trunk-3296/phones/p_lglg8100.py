...
class indexentry(BaseProtogenClass):
    __fields=['index', 'type', 'filename', 'icon', 'dunno1', 'date', 'dunno', 'size']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_filename=USTRING(**{'sizeinbytes': 255, 'raiseonunterminatedread': False, 'raiseontruncate': False })
    ...
    def __setfield_filename(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_filename=USTRING(value,**{'sizeinbytes': 255, 'raiseonunterminatedread': False, 'raiseontruncate': False })
...
class pbgroup(BaseProtogenClass):
    "A single group"
    __fields=['unknown1', 'unknown2', 'name']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_unknown1
            ...
            self.__field_unknown1=UINT(**{'sizeinbytes': 4, 'default': 0xFFFF})
        self.__field_unknown1.writetobuffer(buf)
        try: self.__field_unknown2
        except:
            self.__field_unknown2=UINT(**{'sizeinbytes': 4, 'default': 0xFFFF})
    ...
    def __setfield_unknown1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown1=UINT(value,**{'sizeinbytes': 4, 'default': 0xFFFF})
    ...
    def __setfield_unknown2(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown2=UINT(value,**{'sizeinbytes': 4, 'default': 0xFFFF})
...
class pbentry(BaseProtogenClass):
    __fields=['serial1', 'entrysize', 'serial2', 'entrynumber', 'name', 'group', 'emails', 'ringtone', 'msgringtone', 'wallpaper', 'numbertypes', 'numbers', 'unknown']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_entrysize
            ...
            self.__field_entrysize=UINT(**{'sizeinbytes': 2, 'constant': 0x181, 'constantexception': PhoneBookBusyException})
        ...
        try: self.__field_emails
            ...
            self.__field_emails=LIST(**{'elementclass': _gen_p_lglg8100_109, 'length': NUMEMAILS})
        ...
        try: self.__field_numbertypes
            ...
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lglg8100_114, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lglg8100_116, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_entrysize(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_entrysize=UINT(value,**{'sizeinbytes': 2, 'constant': 0x181, 'constantexception': PhoneBookBusyException})
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lglg8100_109, 'length': NUMEMAILS})
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lglg8100_114, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lglg8100_116, 'length': NUMPHONENUMBERS})
...
class _gen_p_lglg8100_109(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_109,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_109:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_109,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_109,kwargs)
        if len(args):
...
class _gen_p_lglg8100_114(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_114,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_114:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_114,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_114,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lglg8100_116(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_116,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_116:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_116,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_116,kwargs)
        if len(args):
...
class scheduleevent(BaseProtogenClass):
    __fields=['index', 'unknown0', 'unknown1', 'pos', 'description', 'start', 'end', 'repeat', 'alarmindex_vibrate', 'ringtone', 'unknown2', 'alarmminutes', 'alarmhours', 'unknown3']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_unknown0
            ...
            self.__field_unknown0=UINT(**{'sizeinbytes': 1,  'default':1})
        self.__field_unknown0.writetobuffer(buf)
        try: self.__field_unknown1
        except:
            self.__field_unknown1=UINT(**{'sizeinbytes': 4,  'default':0})
        self.__field_unknown1.writetobuffer(buf)
        self.__field_pos.writetobuffer(buf)
        ...
        try: self.__field_unknown3
            ...
            self.__field_unknown3=UINT(**{'sizeinbytes': 1,  'default':0})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_repeat=TELUSLGCALREPEAT(**{'sizeinbytes': 4})
    ...
    def __setfield_unknown0(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown0=UINT(value,**{'sizeinbytes': 1,  'default':1})
    ...
    def __setfield_unknown1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown1=UINT(value,**{'sizeinbytes': 4,  'default':0})
    def __delfield_unknown1(self): del self.__field_unknown1
    unknown1=property(__getfield_unknown1, __setfield_unknown1, __delfield_unknown1, None)
    def __getfield_pos(self):
        return self.__field_pos.getvalue()
    ...
    def __setfield_repeat(self, value):
        if isinstance(value,TELUSLGCALREPEAT):
            self.__field_repeat=value
        else:
            self.__field_repeat=TELUSLGCALREPEAT(value,**{'sizeinbytes': 4})
    ...
    alarmminutes=property(__getfield_alarmminutes, __setfield_alarmminutes, __delfield_alarmminutes, "a value of 0x64 indicates not set")
    ...
    alarmhours=property(__getfield_alarmhours, __setfield_alarmhours, __delfield_alarmhours, "a value of 0x64 indicates not set")
    ...
    def __setfield_unknown3(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown3=UINT(value,**{'sizeinbytes': 1,  'default':0})
    ...
    def containerelements(self):
        ...
        yield ('unknown2', self.__field_unknown2, None)
        yield ('alarmminutes', self.__field_alarmminutes, "a value of 0x64 indicates not set")
        yield ('alarmhours', self.__field_alarmhours, "a value of 0x64 indicates not set")
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lglg8100_234, 'length': 219})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lglg8100_234, 'length': 219})
...
class _gen_p_lglg8100_234(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_234,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_234:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_234,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_234,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_out(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_recipients
            ...
            self.__field_recipients=LIST(**{'elementclass': recipient_record,'length': 7})
    ...
    def __setfield_recipients(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_recipients=LIST(value,**{'elementclass': recipient_record,'length': 7})
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lglg8100_273, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lglg8100_273, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lglg8100_273, 'length': 181})
    def __delfield_msg(self): del self.__field_msg
    msg=property(__getfield_msg, __setfield_msg, __delfield_msg, None)
    def iscontainer(self):
        return True
...
class _gen_p_lglg8100_273(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_273,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_273:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_273,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_273,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lglg8100_285, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lglg8100_305, 'length': 1})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown12=DATA(**{'sizeinbytes': 20})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lglg8100_285, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lglg8100_305, 'length': 1})
    ...
    def __setfield_unknown12(self, value):
        if isinstance(value,DATA):
            ...
            self.__field_unknown12=DATA(value,**{'sizeinbytes': 20})
    ...
    def __setfield_senders_name(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_senders_name=USTRING(value,)
...
class _gen_p_lglg8100_285(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_285,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_285:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_285,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_285,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lglg8100_305(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_305,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_305:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_305,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_305,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lglg8100_319, }
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lglg8100_319, })
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lglg8100_319, })
    def __delfield_msgs(self): del self.__field_msgs
    msgs=property(__getfield_msgs, __setfield_msgs, __delfield_msgs, None)
    def iscontainer(self):
        return True
...
class _gen_p_lglg8100_319(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lglg8100_319,self).__init__(**dict)
        if self.__class__ is _gen_p_lglg8100_319:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lglg8100_319,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglg8100_319,kwargs)
        if len(args):
