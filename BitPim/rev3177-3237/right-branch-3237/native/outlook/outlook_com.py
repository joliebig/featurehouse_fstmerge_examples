...
PropertyPage_vtables_dispatch_ = 1
PropertyPage_vtables_ = [
...
_IDocSiteControl_vtables_dispatch_ = 1
_IDocSiteControl_vtables_ = [
...
_IRecipientControl_vtables_dispatch_ = 1
_IRecipientControl_vtables_ = [
