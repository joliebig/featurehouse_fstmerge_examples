...
class firmwareresponse(BaseProtogenClass):
    __fields=['command', 'date1', 'time1', 'date2', 'time2', 'firmwareversion']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        self.__field_firmwareversion.writetobuffer(buf)
    ...
    def __getfield_firmwareversion(self):
    ...
    firmwareversion=property(__getfield_firmwareversion, __setfield_firmwareversion, __delfield_firmwareversion, None)
    ...
    def containerelements(self):
        ...
        yield ('firmwareversion', self.__field_firmwareversion, None)
...
class pbentry(BaseProtogenClass):
    __fields=['serial1', 'unknown3', 'unknown4', 'unknown5', 'unknown6', 'unknown7', 'serial2', 'unknown8', 'unknown9', 'unknown10', 'name', 'group', 'unknown11', 'ringtone', 'unknown12', 'unknown13', 'memo', 'emails', 'url', 'avatar', 'numberspeeddials', 'numbertypes', 'numbers', 'unknown14']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_unknown3
            ...
            self.__field_unknown3=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown3.writetobuffer(buf)
        try: self.__field_unknown4
        except:
            self.__field_unknown4=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown4.writetobuffer(buf)
        try: self.__field_unknown5
        except:
            self.__field_unknown5=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown5.writetobuffer(buf)
        try: self.__field_unknown6
        except:
            self.__field_unknown6=UINT(**{'sizeinbytes': 1, 'constant': 0x72})
        self.__field_unknown6.writetobuffer(buf)
        self.__field_unknown7.writetobuffer(buf)
        self.__field_serial2.writetobuffer(buf)
        try: self.__field_unknown8
        except:
            self.__field_unknown8=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown8.writetobuffer(buf)
        try: self.__field_unknown9
        except:
            self.__field_unknown9=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown9.writetobuffer(buf)
        try: self.__field_unknown10
        except:
            self.__field_unknown10=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown10.writetobuffer(buf)
        self.__field_name.writetobuffer(buf)
        self.__field_group.writetobuffer(buf)
        try: self.__field_unknown11
        except:
            self.__field_unknown11=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown11.writetobuffer(buf)
        self.__field_ringtone.writetobuffer(buf)
        self.__field_unknown12.writetobuffer(buf)
        try: self.__field_unknown13
        except:
            self.__field_unknown13=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown13.writetobuffer(buf)
        self.__field_memo.writetobuffer(buf)
        try: self.__field_emails
        except:
            self.__field_emails=LIST(**{'elementclass': _gen_p_lgvi125_134, 'length': NUMEMAILS})
        self.__field_emails.writetobuffer(buf)
        self.__field_url.writetobuffer(buf)
        self.__field_avatar.writetobuffer(buf)
        try: self.__field_numberspeeddials
        except:
            self.__field_numberspeeddials=LIST(**{'elementclass': _gen_p_lgvi125_138, 'length': NUMPHONENUMBERS})
        self.__field_numberspeeddials.writetobuffer(buf)
        try: self.__field_numbertypes
        except:
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvi125_140, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lgvi125_142, 'length': NUMPHONENUMBERS})
        self.__field_numbers.writetobuffer(buf)
        try: self.__field_unknown14
        except:
            self.__field_unknown14=UINT(**{'sizeinbytes': 1, 'constant': 0x7c})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_serial1=UINT(**{'sizeinbytes': 1})
        ...
        self.__field_unknown7=UINT(**{'sizeinbytes': 1})
        self.__field_unknown7.readfrombuffer(buf)
        self.__field_serial2=UINT(**{'sizeinbytes': 1})
        ...
        self.__field_unknown10=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown10.readfrombuffer(buf)
        ...
        self.__field_unknown12=UINT(**{'sizeinbytes': 1})
        self.__field_unknown12.readfrombuffer(buf)
        self.__field_unknown13=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown13.readfrombuffer(buf)
        ...
        self.__field_avatar=UINT(**{'sizeinbytes': 4})
        self.__field_avatar.readfrombuffer(buf)
        self.__field_numberspeeddials=LIST(**{'elementclass': _gen_p_lgvi125_138, 'length': NUMPHONENUMBERS})
        self.__field_numberspeeddials.readfrombuffer(buf)
        self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvi125_140, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_serial1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_serial1=UINT(value,**{'sizeinbytes': 1})
    ...
    def __setfield_unknown3(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown3=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown4(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown4=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown5(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown5=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown6(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown6=UINT(value,**{'sizeinbytes': 1, 'constant': 0x72})
    ...
    def __setfield_unknown7(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown7=UINT(value,**{'sizeinbytes': 1})
    ...
    def __setfield_serial2(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_serial2=UINT(value,**{'sizeinbytes': 1})
    ...
    def __setfield_unknown8(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown8=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown9(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown9=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __getfield_unknown10(self):
        try: self.__field_unknown10
        except:
            self.__field_unknown10=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        return self.__field_unknown10.getvalue()
    def __setfield_unknown10(self, value):
        if isinstance(value,UINT):
            self.__field_unknown10=value
        else:
            self.__field_unknown10=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    def __delfield_unknown10(self): del self.__field_unknown10
    unknown10=property(__getfield_unknown10, __setfield_unknown10, __delfield_unknown10, None)
    ...
    def __setfield_unknown11(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown11=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown12(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown12=UINT(value,**{'sizeinbytes': 1})
    ...
    def __getfield_unknown13(self):
        try: self.__field_unknown13
        except:
            self.__field_unknown13=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        return self.__field_unknown13.getvalue()
    def __setfield_unknown13(self, value):
        if isinstance(value,UINT):
            self.__field_unknown13=value
        else:
            self.__field_unknown13=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    def __delfield_unknown13(self): del self.__field_unknown13
    unknown13=property(__getfield_unknown13, __setfield_unknown13, __delfield_unknown13, None)
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgvi125_134, 'length': NUMEMAILS})
    ...
    def __getfield_avatar(self):
        return self.__field_avatar.getvalue()
    def __setfield_avatar(self, value):
        if isinstance(value,UINT):
            self.__field_avatar=value
        else:
            self.__field_avatar=UINT(value,**{'sizeinbytes': 4})
    def __delfield_avatar(self): del self.__field_avatar
    avatar=property(__getfield_avatar, __setfield_avatar, __delfield_avatar, None)
    def __getfield_numberspeeddials(self):
        try: self.__field_numberspeeddials
        except:
            self.__field_numberspeeddials=LIST(**{'elementclass': _gen_p_lgvi125_138, 'length': NUMPHONENUMBERS})
        return self.__field_numberspeeddials.getvalue()
    def __setfield_numberspeeddials(self, value):
        if isinstance(value,LIST):
            self.__field_numberspeeddials=value
        else:
            self.__field_numberspeeddials=LIST(value,**{'elementclass': _gen_p_lgvi125_138, 'length': NUMPHONENUMBERS})
    def __delfield_numberspeeddials(self): del self.__field_numberspeeddials
    numberspeeddials=property(__getfield_numberspeeddials, __setfield_numberspeeddials, __delfield_numberspeeddials, None)
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgvi125_140, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lgvi125_142, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_unknown14(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown14=UINT(value,**{'sizeinbytes': 1, 'constant': 0x7c})
    ...
    def containerelements(self):
        ...
        yield ('unknown10', self.__field_unknown10, None)
        ...
        yield ('unknown13', self.__field_unknown13, None)
        yield ('memo', self.__field_memo, None)
        yield ('emails', self.__field_emails, None)
        yield ('url', self.__field_url, None)
        yield ('avatar', self.__field_avatar, None)
        yield ('numberspeeddials', self.__field_numberspeeddials, None)
...
class _gen_p_lgvi125_134(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['email']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_134,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_134:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_134,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_134,kwargs)
        if len(args):
...
class _gen_p_lgvi125_138(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numberspeeddial']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_138,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_138:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_138,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_138,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
            self.__field_numberspeeddial=UINT(*args,**dict2)
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        self.__field_numberspeeddial.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        'Reads this packet from the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_numberspeeddial=UINT(**{'sizeinbytes': 1})
        self.__field_numberspeeddial.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def __getfield_numberspeeddial(self):
        return self.__field_numberspeeddial.getvalue()
    def __setfield_numberspeeddial(self, value):
        if isinstance(value,UINT):
            self.__field_numberspeeddial=value
        else:
            self.__field_numberspeeddial=UINT(value,**{'sizeinbytes': 1})
    def __delfield_numberspeeddial(self): del self.__field_numberspeeddial
    numberspeeddial=property(__getfield_numberspeeddial, __setfield_numberspeeddial, __delfield_numberspeeddial, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('numberspeeddial', self.__field_numberspeeddial, None)
class _gen_p_lgvi125_140(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_140,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_140:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_140,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_140,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvi125_142(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['number']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_142,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_142:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_142,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_142,kwargs)
        if len(args):
...
class pbgroup(BaseProtogenClass):
    "A single group"
    __fields=['number', 'unknown1', 'ring', 'unknown2', 'unknown3', 'unknown4', 'unknown5', 'unknown6', 'unknown7', 'unknown8', 'name']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        self.__field_ring.writetobuffer(buf)
        try: self.__field_unknown2
        except:
            self.__field_unknown2=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        ...
        try: self.__field_unknown4
            ...
            self.__field_unknown4=UINT(**{'sizeinbytes': 1, 'constant': 0x01})
        self.__field_unknown4.writetobuffer(buf)
        try: self.__field_unknown5
        except:
            self.__field_unknown5=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        ...
        try: self.__field_unknown6
            ...
            self.__field_unknown6=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        self.__field_unknown6.writetobuffer(buf)
        self.__field_unknown7.writetobuffer(buf)
        self.__field_unknown8.writetobuffer(buf)
        self.__field_name.writetobuffer(buf)
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_ring=UINT(**{'sizeinbytes': 1})
        self.__field_ring.readfrombuffer(buf)
        self.__field_unknown2=UINT(**{'sizeinbytes': 1, 'constant': 0x00})
        ...
        self.__field_unknown7=UINT(**{'sizeinbytes': 1})
        self.__field_unknown7.readfrombuffer(buf)
        self.__field_unknown8=UINT(**{'sizeinbytes': 1})
        self.__field_unknown8.readfrombuffer(buf)
    ...
    def __getfield_ring(self):
        return self.__field_ring.getvalue()
    def __setfield_ring(self, value):
        if isinstance(value,UINT):
            self.__field_ring=value
        else:
            self.__field_ring=UINT(value,**{'sizeinbytes': 1})
    def __delfield_ring(self): del self.__field_ring
    ring=property(__getfield_ring, __setfield_ring, __delfield_ring, None)
    ...
    def __setfield_unknown2(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown2=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    ...
    def __setfield_unknown4(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown4=UINT(value,**{'sizeinbytes': 1, 'constant': 0x01})
    def __delfield_unknown4(self): del self.__field_unknown4
    unknown4=property(__getfield_unknown4, __setfield_unknown4, __delfield_unknown4, None)
    def __getfield_unknown5(self):
        try: self.__field_unknown5
    ...
    def __setfield_unknown6(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown6=UINT(value,**{'sizeinbytes': 1, 'constant': 0x00})
    def __delfield_unknown6(self): del self.__field_unknown6
    unknown6=property(__getfield_unknown6, __setfield_unknown6, __delfield_unknown6, None)
    def __getfield_unknown7(self):
        return self.__field_unknown7.getvalue()
    ...
    def __setfield_unknown8(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown8=UINT(value,**{'sizeinbytes': 1})
    def __delfield_unknown8(self): del self.__field_unknown8
    unknown8=property(__getfield_unknown8, __setfield_unknown8, __delfield_unknown8, None)
    def __getfield_name(self):
        return self.__field_name.getvalue()
    ...
    def containerelements(self):
        ...
        yield ('ring', self.__field_ring, None)
...
class pbseqgroup(BaseProtogenClass):
    __fields=['number', 'unknown']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(pbseqgroup,self).__init__(**dict)
        if self.__class__ is pbseqgroup:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(pbseqgroup,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(pbseqgroup,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_number=UINT(**{'sizeinbytes': 1})
        self.__field_number.readfrombuffer(buf)
        self.__field_unknown=UINT(**{'sizeinbytes': 1})
    ...
    def __setfield_unknown(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown=UINT(value,**{'sizeinbytes': 1})
...
class pbseqgroups(BaseProtogenClass):
    __fields=['seqgroups']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(pbseqgroups,self).__init__(**dict)
        if self.__class__ is pbseqgroups:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(pbseqgroups,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(pbseqgroups,kwargs)
        if len(args):
            dict2={'elementclass': pbseqgroup, 'length': NUMGROUPS}
            dict2.update(kwargs)
            kwargs=dict2
            self.__field_seqgroups=LIST(*args,**dict2)
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        try: self.__field_seqgroups
        except:
            self.__field_seqgroups=LIST(**{'elementclass': pbseqgroup, 'length': NUMGROUPS})
        self.__field_seqgroups.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        'Reads this packet from the supplied buffer'
        ...
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_seqgroups=LIST(**{'elementclass': pbseqgroup, 'length': NUMGROUPS})
        self.__field_seqgroups.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def __getfield_seqgroups(self):
        try: self.__field_seqgroups
        except:
            self.__field_seqgroups=LIST(**{'elementclass': pbseqgroup, 'length': NUMGROUPS})
        return self.__field_seqgroups.getvalue()
    def __setfield_seqgroups(self, value):
        if isinstance(value,LIST):
            self.__field_seqgroups=value
        else:
            self.__field_seqgroups=LIST(value,**{'elementclass': pbseqgroup, 'length': NUMGROUPS})
    def __delfield_seqgroups(self): del self.__field_seqgroups
    seqgroups=property(__getfield_seqgroups, __setfield_seqgroups, __delfield_seqgroups, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('seqgroups', self.__field_seqgroups, None)
class pbmapgroup(BaseProtogenClass):
    __fields=['number', 'unknown']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(pbmapgroup,self).__init__(**dict)
        if self.__class__ is pbmapgroup:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(pbmapgroup,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(pbmapgroup,kwargs)
        if len(args): raise TypeError('Unexpected arguments supplied: '+`args`)
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
    ...
    def containerelements(self):
        yield ('number', self.__field_number, None)
        yield ('unknown', self.__field_unknown, None)
class pbmapgroups(BaseProtogenClass):
    __fields=['mapgroups']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(pbmapgroups,self).__init__(**dict)
        if self.__class__ is pbmapgroups:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(pbmapgroups,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(pbmapgroups,kwargs)
        if len(args):
            dict2={'elementclass': pbmapgroup, 'length': NUMMAPGROUPS}
            dict2.update(kwargs)
            kwargs=dict2
            self.__field_mapgroups=LIST(*args,**dict2)
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        'Writes this packet to the supplied buffer'
        self._bufferstartoffset=buf.getcurrentoffset()
        try: self.__field_mapgroups
        except:
            self.__field_mapgroups=LIST(**{'elementclass': pbmapgroup, 'length': NUMMAPGROUPS})
        self.__field_mapgroups.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        'Reads this packet from the supplied buffer'
        ...
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_mapgroups=LIST(**{'elementclass': pbmapgroup, 'length': NUMMAPGROUPS})
        self.__field_mapgroups.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    def __getfield_mapgroups(self):
        try: self.__field_mapgroups
        except:
            self.__field_mapgroups=LIST(**{'elementclass': pbmapgroup, 'length': NUMMAPGROUPS})
        return self.__field_mapgroups.getvalue()
    def __setfield_mapgroups(self, value):
        if isinstance(value,LIST):
            self.__field_mapgroups=value
        else:
            self.__field_mapgroups=LIST(value,**{'elementclass': pbmapgroup, 'length': NUMMAPGROUPS})
    def __delfield_mapgroups(self): del self.__field_mapgroups
    mapgroups=property(__getfield_mapgroups, __setfield_mapgroups, __delfield_mapgroups, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('mapgroups', self.__field_mapgroups, None)
...
class scheduleevent(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_ringtone=UINT(**{'sizeinbytes': 1})
        self.__field_ringtone.readfrombuffer(buf)
        self.__field_description=STRING(**{'sizeinbytes': 39, 'raiseontruncate': False })
    ...
    def __setfield_description(self, value):
        if isinstance(value,STRING):
            ...
            self.__field_description=STRING(value,**{'sizeinbytes': 39, 'raiseontruncate': False })
...
class call(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown3.readfrombuffer(buf)
        self.__field_pbentrynum=UINT(**{'sizeinbytes': 1})
    ...
    def __setfield_pbentrynum(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_pbentrynum=UINT(value,**{'sizeinbytes': 1})
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvi125_290, 'length': 219})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvi125_290, 'length': 219})
...
class _gen_p_lgvi125_290(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_290,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_290:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_290,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_290,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_out(BaseProtogenClass):
    __fields=['index', 'locked', 'unknown1', 'timesent', 'subject', 'unknown2', 'num_msg_elements', 'messages', 'unknown5', 'priority', 'unknown7', 'callback', 'recipients']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown7=DATA(**{'sizeinbytes': 14})
        self.__field_unknown7.readfrombuffer(buf)
        self.__field_callback=STRING(**{'sizeinbytes': 49})
    ...
    def __setfield_unknown7(self, value):
        if isinstance(value,DATA):
            ...
            self.__field_unknown7=DATA(value,**{'sizeinbytes': 14})
    def __delfield_unknown7(self): del self.__field_unknown7
    unknown7=property(__getfield_unknown7, __setfield_unknown7, __delfield_unknown7, None)
    ...
    def __setfield_callback(self, value):
        if isinstance(value,STRING):
            ...
            self.__field_callback=STRING(value,**{'sizeinbytes': 49})
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvi125_325, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvi125_325, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvi125_325, 'length': 181})
    def __delfield_msg(self): del self.__field_msg
    msg=property(__getfield_msg, __setfield_msg, __delfield_msg, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('msg', self.__field_msg, None)
class _gen_p_lgvi125_325(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_325,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_325:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_325,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_325,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgvi125_338, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgvi125_356, 'length': 10})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown5.readfrombuffer(buf)
        self.__field_senders_name=STRING(**{'sizeinbytes': 33})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgvi125_338, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgvi125_356, 'length': 10})
    ...
    def __setfield_senders_name(self, value):
        if isinstance(value,STRING):
            ...
            self.__field_senders_name=STRING(value,**{'sizeinbytes': 33})
    ...
    def containerelements(self):
        ...
        yield ('unknown6', self.__field_unknown6, None)
class _gen_p_lgvi125_338(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_338,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_338:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_338,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_338,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvi125_356(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_356,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_356:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_356,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_356,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvi125_372, }
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgvi125_372, })
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgvi125_372, })
    def __delfield_msgs(self): del self.__field_msgs
    msgs=property(__getfield_msgs, __setfield_msgs, __delfield_msgs, None)
    def iscontainer(self):
        return True
    def containerelements(self):
        yield ('msgs', self.__field_msgs, None)
class _gen_p_lgvi125_372(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    def __init__(self, *args, **kwargs):
        dict={}
        dict.update(kwargs)
        super(_gen_p_lgvi125_372,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvi125_372:
            self._update(args,dict)
    def getfields(self):
        return self.__fields
    def _update(self, args, kwargs):
        super(_gen_p_lgvi125_372,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
                del kwargs[key]
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvi125_372,kwargs)
        if len(args):
            dict2={}
            dict2.update(kwargs)
            kwargs=dict2
