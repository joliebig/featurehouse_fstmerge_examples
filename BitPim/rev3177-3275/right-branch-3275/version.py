...
__FROZEN__="$Id: version.py 3210 2006-05-08 05:56:19Z skyjunky $"
import os, sys
import time
name="BitPim"
vendor="$Id: version.py 3210 2006-05-08 05:56:19Z skyjunky $"
...
_headurl="$HeadURL: https://bitpim.svn.sourceforge.net/svnroot/bitpim/developer/skyjunky/new_ringer/src/version.py $".split()[1]
