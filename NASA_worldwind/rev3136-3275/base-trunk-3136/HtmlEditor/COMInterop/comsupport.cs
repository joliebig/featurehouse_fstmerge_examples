...
namespace onlyconnect
{
   ...
   int lFlags);
    ...
    public interface IHTMLCaret
    {
        ...
        [PreserveSig]
        int InsertText(
                       [In] [MarshalAs(UnmanagedType.LPWStr)] String pText,
                       [In] int lLen);
        [return: MarshalAs(UnmanagedType.I4)]
        [PreserveSig]
        int ScrollIntoView();
    ...
    public interface IDisplayServices
    {
        ...
        int GetComputedStyle([In] IMarkupPointer pPointer,
           [Out, MarshalAs(UnmanagedType.Interface)] out object ppComputedStyle);
        [return: MarshalAs(UnmanagedType.I4)]
        [PreserveSig]
