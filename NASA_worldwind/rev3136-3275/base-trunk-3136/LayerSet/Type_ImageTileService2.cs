...
namespace LayerSet
{
 public class Type_ImageTileService2 : Altova.Xml.Node
 {
  public Type_ImageTileService2() : base() { SetCollectionParents(); }
  public Type_ImageTileService2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public Type_ImageTileService2(XmlNode node) : base(node) { SetCollectionParents(); }
  public Type_ImageTileService2(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
