...
namespace capabilities_1_3_0.wms
{
 public class ContactPersonPrimaryType : Altova.Xml.Node
 {
  ...
  {
   for (int i = 0; i < DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "ContactPerson"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "ContactPerson", i);
    InternalAdjustPrefix(DOMNode, true);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "ContactOrganization"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "ContactOrganization", i);
    InternalAdjustPrefix(DOMNode, true);
   }
  }
