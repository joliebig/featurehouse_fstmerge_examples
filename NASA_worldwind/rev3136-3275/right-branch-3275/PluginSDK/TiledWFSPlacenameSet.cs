            ...
            while(currentSouth < 90)
            {
                ...
                while(currentWest < 180)
                {
                    ...
                    WorldWindWFSPlacenameFile placenameFile = new WorldWindWFSPlacenameFile(
                        m_name, m_placenameBaseUrl, m_typename, m_labelfield, currentNorth, currentSouth, currentWest, currentEast);
            ...
            double east)
  {
        ...
        private void DownloadParsePlacenames()
        {
            try
            {
                ...
                string cachefilename = string.Format("Cache//WFS//Placenames//{0}//{1}_{2}_{3}_{4}.xml.gz",
