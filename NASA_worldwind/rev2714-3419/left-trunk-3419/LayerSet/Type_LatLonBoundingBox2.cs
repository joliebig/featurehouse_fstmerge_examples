...
namespace LayerSet
{
 public class Type_LatLonBoundingBox2 : Altova.Xml.Node
 {
  public Type_LatLonBoundingBox2() : base() { SetCollectionParents(); }
  public Type_LatLonBoundingBox2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public Type_LatLonBoundingBox2(XmlNode node) : base(node) { SetCollectionParents(); }
  public Type_LatLonBoundingBox2(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
