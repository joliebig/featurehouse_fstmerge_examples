  ...
  private TreeNode getTreeNodeFromNrlDataSet(XPathNodeIterator iter)
  {
   ...
   else
   {
    ...
    if(geographicBoundingBoxIter.Count > 0)
    {
     ...
     north = double.Parse(getInnerTextFromFirstChild(geographicBoundingBoxIter.Current.Select("North/Value")));
     south = double.Parse(getInnerTextFromFirstChild(geographicBoundingBoxIter.Current.Select("South/Value")));
     east = double.Parse(getInnerTextFromFirstChild(geographicBoundingBoxIter.Current.Select("East/Value")));
     west = double.Parse(getInnerTextFromFirstChild(geographicBoundingBoxIter.Current.Select("West/Value")));
