  ...
  public override void Render(DrawArgs drawArgs)
  {
   ...
   try
   {
    ...
    if (m_mouseOver)
    {
     ...
     {
      Vector3 translationVector = new Vector3(
       (float)(mouseOverIcon.Position.X - drawArgs.WorldCamera.ReferenceCenter.X),
       (float)(mouseOverIcon.Position.Y - drawArgs.WorldCamera.ReferenceCenter.Y),
       (float)(mouseOverIcon.Position.Z - drawArgs.WorldCamera.ReferenceCenter.Z));
      Vector3 projectedPoint = drawArgs.WorldCamera.Project(translationVector);
      mouseOverIcon.MouseOverRender(drawArgs, m_sprite, projectedPoint);
     }
