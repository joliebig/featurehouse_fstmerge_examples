...
namespace capabilities_1_3_0.wms
{
 public class HTTPType : Altova.Xml.Node
 {
  ...
  {
   for (int i = 0; i < DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "Get"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Get", i);
    InternalAdjustPrefix(DOMNode, true);
    new GetType(DOMNode).AdjustPrefix();
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "Post"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Post", i);
    InternalAdjustPrefix(DOMNode, true);
  ...
  {
   return DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "Get");
  }
  public int GetCount
  {
   get
  ...
  public bool HasGet()
  {
   return HasDomChild(NodeType.Element, "http://www.opengis.net/wms", "Get");
  }
  public GetType GetGetAt(int index)
  {
   return new GetType(GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Get", index));
  }
  ...
  {
   RemoveDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Get", index);
  }
  ...
  {
   AppendDomElement("http://www.opengis.net/wms", "Get", newValue);
  }
  public void InsertGetAt(GetType newValue, int index)
  {
   InsertDomElementAt("http://www.opengis.net/wms", "Get", index, newValue);
  }
  public void ReplaceGetAt(GetType newValue, int index)
  {
   ReplaceDomElementAt("http://www.opengis.net/wms", "Get", index, newValue);
  }
  ...
  {
   return DomChildCount(NodeType.Element, "http://www.opengis.net/wms", "Post");
  }
  ...
  public bool HasPost()
  {
   return HasDomChild(NodeType.Element, "http://www.opengis.net/wms", "Post");
  }
  public PostType GetPostAt(int index)
  {
   return new PostType(GetDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Post", index));
  }
  ...
  {
   RemoveDomChildAt(NodeType.Element, "http://www.opengis.net/wms", "Post", index);
  }
  ...
  {
   AppendDomElement("http://www.opengis.net/wms", "Post", newValue);
  }
  public void InsertPostAt(PostType newValue, int index)
  {
   InsertDomElementAt("http://www.opengis.net/wms", "Post", index, newValue);
  }
  public void ReplacePostAt(PostType newValue, int index)
  {
   ReplaceDomElementAt("http://www.opengis.net/wms", "Post", index, newValue);
  }
