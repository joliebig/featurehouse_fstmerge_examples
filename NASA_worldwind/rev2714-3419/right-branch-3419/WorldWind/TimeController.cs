    ...
    public class TimeController : WorldWind.PluginEngine.Plugin
    {
        ...
        public override void Load()
        {
            try
            {
                ...
                m_window.ClientSize = new System.Drawing.Size(500, 183);
                m_window.Anchor = WorldWind.NewWidgets.WidgetEnums.AnchorStyles.Right | WorldWind.NewWidgets.WidgetEnums.AnchorStyles.Bottom;
        ...
        void close_OnMouseUpEvent(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            m_window.Visible = false;
        }
