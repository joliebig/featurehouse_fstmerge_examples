...
namespace WorldWind
{
 public class PlaceFinder : System.Windows.Forms.Form
 {
  ...
  private void InitializeComponent()
  {
   ...
   this.tabPage2.Text = "Yahoo! Search (USA)";
   ...
   this.groupBox3.Text = "Yahoo! Simple Search (USA)";
   ...
   this.tabPage5.Text = "Yahoo! Search (USA)";
   ...
   this.groupBox7.Text = "Yahoo! Simple Search (USA)";
  ...
  private void buttonGo_Click(object sender, System.EventArgs e)
  {
   try
   {
    double lat = double.Parse(this.textBoxLatitude.Text,CultureInfo.InvariantCulture);
    double lon = double.Parse(this.textBoxLongitude.Text,CultureInfo.InvariantCulture);
