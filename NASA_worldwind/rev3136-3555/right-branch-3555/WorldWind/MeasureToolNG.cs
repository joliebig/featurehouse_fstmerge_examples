...
namespace MeasureToolNewgen.Plugins
{
  ...
  private System.Windows.Forms.Label measureLabel;
        private void InitializeComponent()
        {
            ...
            this.zedGraphControl1.Location = new System.Drawing.Point(16, 32);
            ...
            this.zedGraphControl1.Size = new System.Drawing.Size(499, 150);
    ...
    public delegate void TerrainProfiler(ArrayList elevProfile);
    class MeasureToolLayer : LineFeature
    {
        ...
        public TerrainProfiler Profiler;
  ...
  public ArrayList ElevationProfile()
  {
   ...
   Angle startLat, startLon, endLat, endLon = Angle.Zero;
            if (Points.Length > 1)
            {
                int segmentEndPointIndex = Points.Length - 1;
                ...
                for (int i = 1; i < samples; i++)
                {
                    ...
                    double elevi = (double)world.TerrainAccessor.GetElevationAt(lat.Degrees, lon.Degrees, 1000);
