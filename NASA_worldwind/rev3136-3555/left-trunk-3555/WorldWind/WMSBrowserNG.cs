...
namespace WorldWind
{
   ...
   this.pictureBoxOGC1.Location = new System.Drawing.Point(6, 19);
   ...
   this.pictureBoxOGC1.Size = new System.Drawing.Size(202, 158);
   ...
   foreach (TreeNode node in treeOgcCaps.Nodes)
   {
    wmslayerset += ParseNodeChildren(node);
   }
