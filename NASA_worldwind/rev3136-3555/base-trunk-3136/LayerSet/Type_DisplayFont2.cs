...
namespace LayerSet
{
 public class Type_DisplayFont2 : Altova.Xml.Node
 {
  public Type_DisplayFont2() : base() { SetCollectionParents(); }
  public Type_DisplayFont2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public Type_DisplayFont2(XmlNode node) : base(node) { SetCollectionParents(); }
  public Type_DisplayFont2(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  public override void AdjustPrefix()
  {
   ...
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "Style"); i++)
   {
    ...
    InternalAdjustPrefix(DOMNode, true);
    new StyleType2(DOMNode).AdjustPrefix();
   }
  }
  ...
  {
   return new StyleType2(GetDomChildAt(NodeType.Element, "", "Style", index));
  }
