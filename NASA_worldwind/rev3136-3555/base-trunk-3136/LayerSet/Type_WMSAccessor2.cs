...
namespace LayerSet
{
 ...
 {
  public Type_WMSAccessor2() : base() { SetCollectionParents(); }
  public Type_WMSAccessor2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public Type_WMSAccessor2(XmlNode node) : base(node) { SetCollectionParents(); }
  public Type_WMSAccessor2(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  ...
  {
   return new BoundingBoxOverlapType2(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "BoundingBoxOverlap", index)));
  }
