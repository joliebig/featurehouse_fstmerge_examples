...
namespace WorldWind
{
 public class WorldWindow : Control, IGlobe
 {
  ...
  protected override void OnMouseWheel(MouseEventArgs e)
            ...
            try
   {
    if(this._menuBar.OnMouseWheel(e))
     return;
    this.drawArgs.WorldCamera.ZoomStepped( e.Delta/((double)120) );
   }
   finally
   {
  ...
  System.DateTime m_lastClick = System.DateTime.Now;
  protected override void OnMouseUp(MouseEventArgs e)
        {
            DrawArgs.LastMousePosition.X = e.X;
   DrawArgs.LastMousePosition.Y = e.Y;
   System.DateTime now = System.DateTime.Now;
   if(now.Subtract(m_lastClick) < TimeSpan.FromMilliseconds(300))
   {
    isDoubleClick = true;
   }
   m_lastClick = now;
