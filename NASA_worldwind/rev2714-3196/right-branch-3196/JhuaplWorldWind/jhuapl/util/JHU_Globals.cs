  ...
  public static void Initialize(WorldWindow worldWindow)
  {
   lock (typeof(JHU_Globals))
   {
    ...
    if (m_controlForm == null)
    {
     ...
     m_zoomInWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_in.png";
     ...
     m_zoomOutWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_out.png";
     ...
     m_zoomWorldWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_world.png";
     m_zoomWorldWidget.ImageName = "http:";
     ...
     m_zoomCountryWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_country.png";
     ...
     m_zoomStateWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_state.png";
     ...
     m_zoomCityWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_city.png";
     ...
     m_zoomBldgWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_building.png";
     ...
     m_resetWidget.ImageName = m_basePath + @"\Plugins\Navigator\" + "button_reset.png";
