...
namespace capabilities_1_1_1
{
 public class ContactAddressType : Altova.Xml.Node
 {
  ...
  {
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "AddressType"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "AddressType", i);
    InternalAdjustPrefix(DOMNode, false);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "Address"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "Address", i);
    InternalAdjustPrefix(DOMNode, false);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "City"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "City", i);
    InternalAdjustPrefix(DOMNode, false);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "StateOrProvince"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "StateOrProvince", i);
    InternalAdjustPrefix(DOMNode, false);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "PostCode"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "PostCode", i);
    InternalAdjustPrefix(DOMNode, false);
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "Country"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "Country", i);
    InternalAdjustPrefix(DOMNode, false);
   }
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "AddressType", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "AddressType", newValue.ToString());
  }
  public void InsertAddressTypeAt(SchemaString newValue, int index)
  {
   InsertDomChildAt(NodeType.Element, "", "AddressType", index, newValue.ToString());
  }
  public void ReplaceAddressTypeAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "AddressType", index, newValue.ToString());
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "Address", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "Address", newValue.ToString());
  }
  public void InsertAddressAt(SchemaString newValue, int index)
  {
   InsertDomChildAt(NodeType.Element, "", "Address", index, newValue.ToString());
  }
  public void ReplaceAddressAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "Address", index, newValue.ToString());
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "City", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "City", newValue.ToString());
  }
  public void InsertCityAt(SchemaString newValue, int index)
  {
   InsertDomChildAt(NodeType.Element, "", "City", index, newValue.ToString());
  }
  public void ReplaceCityAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "City", index, newValue.ToString());
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "StateOrProvince", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "StateOrProvince", newValue.ToString());
  }
  public void InsertStateOrProvinceAt(SchemaString newValue, int index)
  {
   InsertDomChildAt(NodeType.Element, "", "StateOrProvince", index, newValue.ToString());
  }
  public void ReplaceStateOrProvinceAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "StateOrProvince", index, newValue.ToString());
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "PostCode", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "PostCode", newValue.ToString());
  }
  ...
  {
   return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "Country", index)));
  }
  ...
  {
   AppendDomChild(NodeType.Element, "", "Country", newValue.ToString());
  }
  public void InsertCountryAt(SchemaString newValue, int index)
  {
   InsertDomChildAt(NodeType.Element, "", "Country", index, newValue.ToString());
  }
  public void ReplaceCountryAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "Country", index, newValue.ToString());
  }
