...
{
 public class GetLegendGraphicType : Altova.Xml.Node
 {
  public GetLegendGraphicType() : base() { SetCollectionParents(); }
  public GetLegendGraphicType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public GetLegendGraphicType(XmlNode node) : base(node) { SetCollectionParents(); }
  public GetLegendGraphicType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  ...
  public void ReplaceFormatAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "Format", index, newValue.ToString());
        ...
        {
            GetLegendGraphicType parent;
            public GetLegendGraphicType Parent
   {
    set
    {
     parent = value;
