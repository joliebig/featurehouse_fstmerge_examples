...
{
 public class GetStylesType : Altova.Xml.Node
 {
  public GetStylesType() : base() { SetCollectionParents(); }
  public GetStylesType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public GetStylesType(XmlNode node) : base(node) { SetCollectionParents(); }
  public GetStylesType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  ...
  public void ReplaceFormatAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "Format", index, newValue.ToString());
        ...
        {
            GetStylesType parent;
            public GetStylesType Parent
   {
    set
    {
     parent = value;
