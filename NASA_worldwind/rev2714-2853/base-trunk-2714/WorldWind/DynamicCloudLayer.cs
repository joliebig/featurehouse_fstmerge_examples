...
namespace WorldWind
{
 public class DynamicCloudLayer : WorldWind.Renderable.RenderableObject
 {
  string m_remoteUrl;
  string m_imageDirectoryPath;
  double m_cloudBaseAltitude = 30000;
  double m_displacementMultiplier = 500;
  int m_samples = 200;
  System.Timers.Timer m_animationTimer = null;
  int m_frameIntervalMs = 400;
