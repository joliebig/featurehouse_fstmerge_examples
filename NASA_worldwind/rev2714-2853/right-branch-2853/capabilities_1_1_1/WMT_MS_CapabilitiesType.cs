...
{
 public class WMT_MS_CapabilitiesType : Altova.Xml.Node
 {
  public WMT_MS_CapabilitiesType() : base() { SetCollectionParents(); }
  public WMT_MS_CapabilitiesType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public WMT_MS_CapabilitiesType(XmlNode node) : base(node) { SetCollectionParents(); }
  public WMT_MS_CapabilitiesType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  public override void AdjustPrefix()
  {
   ...
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "Service"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "Service", i);
    InternalAdjustPrefix(DOMNode, false);
    new ServiceType(DOMNode).AdjustPrefix();
   }
   for (int i = 0; i < DomChildCount(NodeType.Element, "", "Capability"); i++)
   {
    XmlNode DOMNode = GetDomChildAt(NodeType.Element, "", "Capability", i);
    InternalAdjustPrefix(DOMNode, false);
  ...
  {
   return DomChildCount(NodeType.Element, "", "Service");
  }
  ...
  {
   return HasDomChild(NodeType.Element, "", "Service");
  }
  public ServiceType GetServiceAt(int index)
  {
   return new ServiceType(GetDomChildAt(NodeType.Element, "", "Service", index));
  }
  ...
  {
   RemoveDomChildAt(NodeType.Element, "", "Service", index);
  }
  ...
  {
   return DomChildCount(NodeType.Element, "", "Capability");
  }
  ...
  {
   return HasDomChild(NodeType.Element, "", "Capability");
  }
  public CapabilityType GetCapabilityAt(int index)
  {
   return new CapabilityType(GetDomChildAt(NodeType.Element, "", "Capability", index));
  }
  ...
  {
   RemoveDomChildAt(NodeType.Element, "", "Capability", index);
  }
