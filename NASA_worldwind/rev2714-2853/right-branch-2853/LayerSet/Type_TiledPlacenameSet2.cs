...
namespace LayerSet
{
 public class Type_TiledPlacenameSet2 : Altova.Xml.Node
 {
  public Type_TiledPlacenameSet2() : base() { SetCollectionParents(); }
  public Type_TiledPlacenameSet2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public Type_TiledPlacenameSet2(XmlNode node) : base(node) { SetCollectionParents(); }
  public Type_TiledPlacenameSet2(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  ...
  public void ReplaceShowAtStartupAt(SchemaBoolean newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Attribute, "", "ShowAtStartup", index, newValue.ToString());
        ...
        {
            Type_TiledPlacenameSet2 parent;
            public Type_TiledPlacenameSet2 Parent
   {
    set
    {
     parent = value;
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public ShowAtStartupEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceNameAt(SchemaString newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public NameEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceDistanceAboveSurfaceAt(SchemaDecimal newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public DistanceAboveSurfaceEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void AddMinimumDisplayAltitude(MinimumDisplayAltitudeType2 newValue)
  {
  ...
  public void ReplaceMinimumDisplayAltitudeAt(MinimumDisplayAltitudeType2 newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public MinimumDisplayAltitudeEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void AddMaximumDisplayAltitude(MaximumDisplayAltitudeType2 newValue)
  {
  ...
  public void ReplaceMaximumDisplayAltitudeAt(MaximumDisplayAltitudeType2 newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public MaximumDisplayAltitudeEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplacePlacenameListFilePathAt(SchemaString newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public PlacenameListFilePathEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceDisplayFontAt(Type_DisplayFont2 newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public DisplayFontEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceRGBColorAt(Type_RGBColor2 newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public RGBColorEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceWinColorNameAt(SchemaString newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public WinColorNameEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceIconFilePathAt(SchemaString newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public IconFilePathEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
  ...
  public void ReplaceExtendedInformationAt(Type_ExtendedInformation newValue, int index)
  {
   ...
   int nIndex;
   Type_TiledPlacenameSet2 parent;
   public ExtendedInformationEnumerator(Type_TiledPlacenameSet2 par)
   {
    parent = par;
    nIndex = -1;
   }
