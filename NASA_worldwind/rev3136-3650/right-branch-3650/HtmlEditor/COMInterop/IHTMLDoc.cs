...
namespace onlyconnect
{
   ...
   int lIndex);
    ...
    public interface IHTMLDocument3
    {
        ...
        [DispId(dispids.DISPID_IHTMLDOCUMENT3_PARENTDOCUMENT)]
        IHTMLDocument2 parentDocument();
        [DispId(dispids.DISPID_IHTMLDOCUMENT3_ENABLEDOWNLOAD)]
        bool enableDownload { set; get;}
        [DispId(dispids.DISPID_IHTMLDOCUMENT3_BASEURL)]
        String baseUrl { set;get;}
        [DispId(dispids.DISPID_IHTMLDOCUMENT3_CHILDNODES)]
        object childNodes();
        [DispId(dispids.DISPID_IHTMLDOCUMENT3_INHERITSTYLESHEETS)]
    ...
    interface IHTMLDocument4
    {
        ...
        int createRenderStyle([In] String v, [Out, MarshalAs(UnmanagedType.IUnknown)] object ppIHTMLRenderStyle);
...
InterfaceTypeAttribute(ComInterfaceType.InterfaceIsDual),
    ...
    interface IHTMLDocument5
    {
        ...
        void getDoctype([Out] out Object p);
        [DispId(dispids.DISPID_IHTMLDOCUMENT5_IMPLEMENTATION)]
        void getImplementation([Out] out object p);
        [DispId(dispids.DISPID_IHTMLDOCUMENT5_CREATEATTRIBUTE)]
        object createAttribute([In] String bstrattrName);
        [DispId(dispids.DISPID_IHTMLDOCUMENT5_CREATECOMMENT)]
        object createComment([In] String bstrdata);
