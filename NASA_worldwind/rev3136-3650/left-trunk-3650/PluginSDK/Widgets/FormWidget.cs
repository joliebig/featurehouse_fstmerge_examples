 ...
 public class FormWidget : WidgetCollection, WorldWind.NewWidgets.IWidget, WorldWind.NewWidgets.IInteractive
 {
  ...
  public void Render(DrawArgs drawArgs)
  {
   ...
   int widgetRight = this.Right;
            if (VerticalResizeEnabled || HorizontalResizeEnabled)
            {
                    ...
                    WorldWind.DrawArgs.LastMousePosition.Y < widgetBottom + resizeBuffer))
                {
                    ...
                    WorldWind.DrawArgs.LastMousePosition.Y < widgetBottom + resizeBuffer))
                {
                    WorldWind.DrawArgs.MouseCursor = CursorType.SizeNS;
                }
            }
   ...
   if (m_renderBody)
   {
    WidgetUtilities.DrawBox(
     this.AbsoluteLocation.X,
     this.AbsoluteLocation.Y + m_headerHeight,
     m_size.Width,
    ...
    int childBottom = 0;
                ...
                {
                    WorldWind.NewWidgets.IWidget currentChildWidget = m_ChildWidgets[index] as WorldWind.NewWidgets.IWidget;
