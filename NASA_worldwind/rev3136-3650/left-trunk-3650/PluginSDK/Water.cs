            ...
            base(name,parentWorld,meshFilename,lat,lon,alt,scaleFactor,90.0f,0.0f,0.0f)
  {
            ...
            VertexElement[] elements = new VertexElement[]
   {
    ...
    VertexElement.VertexDeclarationEnd,
            ...
            Mesh tempMesh = meshElems[0].mesh.Clone(MeshFlags.Managed, elements, device);
            meshElems[0].mesh.Dispose();
            meshElems[0].mesh = tempMesh;
            meshElems[0].mesh.ComputeTangentFrame(0);
