...
namespace GpsTrackerPlugin
{
 public class GpsTrackerAPRS
 {
   ...
   private struct APRSSTATUS
  {
   ...
   public int rate;
   public byte symbol_table;
   public byte symbol_code;
  }
  [StructLayout(LayoutKind.Sequential)]
   private struct APRSPOSITION
  {
   ...
   public long time_of_fix;
   public double latitude;
   public double longitude;
   public float speed_over_ground;
   public float course_made_good;
   public float altitude;
   public int checksum;
   public byte rx_warning;
   public float magnetic_variance;
   public int quality;
   public int sats;
   public float hor_dilution;
   public float geoidal_separation;
   public float diff_last_update;
   public int diff_station;
   public string name;
  }
