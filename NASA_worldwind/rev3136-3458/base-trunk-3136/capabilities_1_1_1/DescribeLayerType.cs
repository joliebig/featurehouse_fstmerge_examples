...
{
 public class DescribeLayerType : Altova.Xml.Node
 {
  public DescribeLayerType() : base() { SetCollectionParents(); }
  public DescribeLayerType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
  public DescribeLayerType(XmlNode node) : base(node) { SetCollectionParents(); }
  public DescribeLayerType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
  ...
  public void ReplaceFormatAt(SchemaString newValue, int index)
  {
   ReplaceDomChildAt(NodeType.Element, "", "Format", index, newValue.ToString());
        ...
        {
            DescribeLayerType parent;
            public DescribeLayerType Parent
   {
    set
    {
     parent = value;
