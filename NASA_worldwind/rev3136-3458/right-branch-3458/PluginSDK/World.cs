...
namespace WorldWind
{
    ...
    public class AtmosphericScatteringSphere
    {
        ...
        public void SetColor(ref CustomVertex.PositionColored pVertex, DrawArgs drawArgs)
        {
            ...
            float alpha = (fColor[0] + fColor[1] + fColor[2]) / 3;
            alpha = (float)Math.Min(alpha + 0.50, 1f);
        ...
        double thickness;
        Mesh skyMesh;
        private void UpdateSkyMesh(DrawArgs drawArgs)
        {
            ...
            skyMesh = ColoredSphere(drawArgs, (float)domeRadius, horizonLat, zenithLat, 128, 48);
        }
        private Mesh ColoredSphere(DrawArgs drawArgs, float radius, double startLat, double endLat, int slices, int stacks)
        {
