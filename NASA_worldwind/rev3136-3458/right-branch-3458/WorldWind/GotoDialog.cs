...
namespace WorldWind
{
   public class GotoDialog : System.Windows.Forms.Form
   {
      ...
      volatile bool _cancelSearch = false;
    ...
    curIndexedTiledSet.placenameSet.PlacenameListFilePath.Value)));
      ...
      {
         PlaceItem pi = itps.wplIndex.GetPlaceItem(nPos);
         listViewResults.Invoke(listViewResults.addPlaceDelegate, new object[] { pi });
         ...
         do
         {
            ...
            {
               pi = itps.wplIndex.GetPlaceItem(nBelow);
               listViewResults.Invoke(listViewResults.addPlaceDelegate, new object[] { pi });
               --nBelow;
               bFoundOne = true;
            }
            ...
            {
               pi = itps.wplIndex.GetPlaceItem(nAbove);
               listViewResults.Invoke(listViewResults.addPlaceDelegate, new object[] { pi });
               ++nAbove;
               bFoundOne = true;
            }
      ...
      void searchFunc()
      {
         ...
         bool bFastSearch = this.checkBoxFastSearch.Checked;
         bool bPartial = false;
         string searchString;
      ...
      void placelistView_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ...
         if(plw.SelectedItems.Count == 0 ||
            plw.SelectedItems[0].Tag == null) return;
         PlaceItem pi = (PlaceItem)plw.SelectedItems[0].Tag;
         this.numericUpDownLatitude.Value = (decimal)pi.pn.Lat;
         this.numericUpDownLongitude.Value = (decimal)pi.pn.Lon;
         this.numericUpDownAltitude.Value = (decimal)(pi.Altitude/((double)1000));
      ...
      {
         textBoxSearchKeywords.Focus();
         textBoxSearchKeywords.SelectAll();
      ...
      void statusBar_DrawItem(object sender, System.Windows.Forms.StatusBarDrawItemEventArgs sbdevent)
      {
         ...
         {
            this.progressBarSearch.Bounds = sbdevent.Bounds;
         }
      }
