        ...
        public void update(Tile tile) {
            ...
            if (tile != null) {
                ...
                if (tile.isExplored()) {
                    ...
                    items.add(Messages.getName(tile));
                    for (TileImprovement tileImprovement : tile.getCompletedTileImprovements()) {
                        items.add(Messages.getDescription(tileImprovement.getType()));
                    }
                    ...
                    if (tile.getOwner() == null) {
                        ...
                        JLabel ownerLabel = new JLabel(Messages.getNationAsString(tile.getOwner()));
            ...
            if (unit != null) {
                ...
                if (unit.canCarryTreasure()) {
                    ...
                    for (Goods goods : unit.getGoodsList()) {
                        ...
                        goodsLabel.setToolTipText(Messages.message("model.goods.goodsAmount",
                    ...
                    for (Unit carriedUnit : unit.getUnitList()) {
                        ...
                        unitLabel.setToolTipText(Messages.getLabel(carriedUnit));
                        add(unitLabel);
                    }
                } else {
                    for (EquipmentType equipment : unit.getEquipment().keySet()) {
                        for (AbstractGoods goods : equipment.getGoodsRequired()) {
                            ...
                            equipmentLabel.setToolTipText(amountStr + " " + Messages.getName(goods.getType()));
                            add(equipmentLabel);
                        }
                    }
                }
