    ...
    private void buildDebugMenu() {
        ...
        while (it.hasNext()) {
            ...
            if (p.isEuropean() && p.canBuildColonies()) {
                JRadioButtonMenuItem cv2 = new JRadioButtonMenuItem(Messages.getNationAsString(p),
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (FoundingFather father : FreeCol.getSpecification().getFoundingFathers()) {
                        if (!player.hasFather(father)) {
                            fathers.add(new ChoiceItem<FoundingFather>(Messages.getName(father), father));
                        }
                    }
            ...
            public void actionPerformed(ActionEvent e) {
                if (freeColClient.getFreeColServer() != null) {
                    ...
                    for (Player tp : freeColClient.getGame().getPlayers()) {
                        ...
                        sb.append("\n==");
                        sb.append(Messages.getNationAsString(p));
                        sb.append("==\n");
                        ...
                        while (unitIterator.hasNext()) {
                            ...
                            if (u.isVisibleTo(myServerPlayer)) {
                                if (freeColClient.getGame().getFreeColGameObject(u.getId()) == null) {
                                    ...
                                    System.out.println(Messages.getLabel(u) + "(" + u.getId() + "). Position: "
                                    ...
                                    if (clientSideUnit.getTile() != null
                                        ...
                                        System.out.println("Server: " + Messages.getLabel(u) + "(" + u.getId() + "). Position: "
                                                + u.getTile().getPosition());
                                        System.out.println("Client: " + Messages.getLabel(clientSideUnit) + "("
	...
	private void setupSkipTurnsMenuItem() {
        ...
        skipTurnsMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                	...
                	String response = freeColClient.getCanvas().showInputDialog(
