...
public class StandardAIPlayer extends AIPlayer {
    ...
    public void startWorking() {
        logger.fine("Entering AI code for: " + getPlayer().getNation() + ", year " + getGame().getTurn().getYear());
    ...
    private void rearrangeWorkersInColonies() {
        ...
        while (ci.hasNext()) {
            AIColony c = ci.next();
            if (c.getColony().isDisposed()) {
                ci.remove();
                logger.warning("Removed disposed colony " + c.getColony().getName());
            }
    ...
    void secureIndianSettlement(IndianSettlement is) {
        ...
        while (positionIterator.hasNext()) {
            ...
            if (tension == null) {
                logger.warning(getPlayer().getNation() +
                               " tension towards " +
                               enemy.getNation() +
                               " is NULL");
                continue;
