...
public class MapGenerator implements IMapGenerator {
    ...
    private void createIndianSettlements(final Map map, List<Player> players) {
        ...
        for (Territory territory : territories) {
            ...
            if (tile == null) {
                ...
                logger.fine("Placing the " + territory.player.getNation() + 
        ...
        for (Tile tile : settlementTiles) {
            ...
            if (territory == null) {
                ...
                logger.fine("Placing a " + territory.player.getNation() + 
                        " camp in region: " + name +
                        " at Tile: "+ tile.getPosition());
    ...
    private void createEuropeanUnits(Map map, List<Player> players) {
        ...
        for (Player player : players) {
            ...
            if (player.isEuropean()) {
                ...
                logger.finest("found European player " + player.getNation());
            }
        }
        ...
        for (Player player : europeanPlayers) {
            logger.fine("generating units for player " + player.getNation());
            ...
            if (carriers.isEmpty()) {
                logger.warning("No carriers defined for player " + player.getNation());
                startAtSea = false;
            }
            ...
            if (FreeCol.isInDebugMode()) {
                ...
                if (colonyTile != null) {
                    ...
                    String colonyName = Messages.getNationAsString(player) + " Colony";
    ...
    private class Territory {
        ...
        public String toString() {
            return player.getNation() + " territory at " + region.toString();
        }
    }
