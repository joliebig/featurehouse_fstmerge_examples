...
public final class Building extends FreeColGameObject implements WorkLocation, Ownable, Typed<BuildingType> {
    ...
    public String getNextName() {
        ...
        return next == null ? null : Messages.getName(next);
    }
    ...
    public void add(final Locatable locatable) {
        if (!canAdd(locatable)) {
            throw new IllegalStateException("Cannot add " + locatable + " to " + getId());
            ...
            if (unit.isUnderRepair() &&
                ...
                if (!unit.isUnderRepair()) {
                    addModelMessage(this, ModelMessage.MessageType.DEFAULT, this,
                                    ...
                                    "%repairLocation%", Messages.getLocationName(this));
                }
            }
        }
    }
    ...
    private void produceGoods() {
        ...
        if (goodsInput == 0 && !canAutoProduce() && getMaximumGoodsInput() > 0) {
            addModelMessage(getColony(), ModelMessage.MessageType.MISSING_GOODS,
                            ...
                            "%inputGoods%", Messages.getName(goodsInputType),
                            "%building%", Messages.getName(this),
    ...
    private boolean assignStudent(Unit teacher) {
        ...
        if (student == null) {
            addModelMessage(getColony(), ModelMessage.MessageType.WARNING, teacher,
                            ...
                            "%teacher%", Messages.getLabel(teacher),
                            "%colony%", colony.getName());
            return false;
        } else {
