...
namespace UnitTests
{
    ...
    public class SummaryTests : RequiresInitialization
    {
        ...
        public void Trim()
        {
            ...
            Assert.AreEqual("clean upclean upclean up, typos fixed: dissapointment â disappointment (2), attatched â attached (2), begining â beginning, Expiditionary â Expeditionary, manuever â maneuver (5), thier â their (7), independant ",
                            Summary.Trim(
                                "clean upclean upclean up, typos fixed: dissapointment â disappointment (2), attatched â attached (2), begining â beginning, Expiditionary â Expeditionary, manuever â maneuver (5), thier â their (7), independant â independent"));
        }
        [Test]
