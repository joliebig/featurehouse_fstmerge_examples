...
namespace UnitTests
{
    ...
    public class GenfixesTests : GenfixesTestsBase
    {
        ...
        public void DoubleBr()
        {
            ...
            AssertChange(@"* {{Polish2|Krzepice (wojewÃ³dztwo dolnoÅlÄskie)|[[24 November]] [[2007]]}}<br><br>  a", @"* {{Polish2|Krzepice (wojewÃ³dztwo dolnoÅlÄskie)|[[24 November]] [[2007]]}}
a");
        }
        [Test]
