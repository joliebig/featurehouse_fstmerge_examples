...
namespace UnitTests
{
    ...
    {
        const string Hidden = @"ââââM?\d+ââââ",
            AllHidden = @"^(ââââM?\d+ââââ)*$";
        HideText Hider;
...
|def=hello}}");
        ...
        {
            AssertAllHiddenMore(@"<p style=""margin:0px;font-size:100%""><span style=""color:#00ff00"">âª</span> <small>Francophone minorities</small></p>");
