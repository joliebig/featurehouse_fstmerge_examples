...
now").Value);
        ...
        public void MonthDay()
        {
            ...
            RegexAssert.IsMatch(WikiRegexes.MonthDay, @"On July 11â12 a");
        ...
        public void DayMonth()
        {
            ...
            RegexAssert.IsMatch(WikiRegexes.DayMonth, @"On 11â12 July a");
        ...
        {
            RegexAssert.IsMatch(WikiRegexes.MonthDayRangeSpan, @"On July 11â12 a");
            RegexAssert.IsMatch(WikiRegexes.MonthDayRangeSpan, @"On July 11â12, 2004 a");
            RegexAssert.IsMatch(WikiRegexes.MonthDayRangeSpan, @"On July 11â12 2004 a");
            ...
            RegexAssert.NoMatch(WikiRegexes.MonthDayRangeSpan, @"On July 11 12 a");
            RegexAssert.NoMatch(WikiRegexes.MonthDayRangeSpan, @"On 11â12 July a");
        }
        [Test]
        public void DayMonthRangeSpan()
        {
            RegexAssert.IsMatch(WikiRegexes.DayMonthRangeSpan, @"On 11â12 July a");
            RegexAssert.IsMatch(WikiRegexes.DayMonthRangeSpan, @"On 11â12 July, 2004 a");
            ...
            RegexAssert.NoMatch(WikiRegexes.DayMonthRangeSpan, @"On  11 12 July a");
            RegexAssert.NoMatch(WikiRegexes.DayMonthRangeSpan, @"On July 11â12 a");
        }
          [Test]
